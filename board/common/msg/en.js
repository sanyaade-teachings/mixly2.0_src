...
Blockly.MIXLY_RGB_NUM_R_G_B_MP = "Set RGB light, R value, B value, G value, NO. from 0";
...
Blockly.MIXLY_TURTLE_WRITE_MOVE = 'move with text';
Blockly.MIXLY_TURTLE_WRITE_MOVE_TRUE = 'yes';
Blockly.MIXLY_TURTLE_WRITE_MOVE_FALSE = 'no';
Blockly.MIXLY_TURTLE_WRITE_ALIGN = 'align';
Blockly.MIXLY_TURTLE_WRITE_ALIGN_LEFT = 'left';
Blockly.MIXLY_TURTLE_WRITE_ALIGN_CENTER = 'center';
Blockly.MIXLY_TURTLE_WRITE_ALIGN_RIGHT = 'right';
Blockly.MIXLY_TURTLE_WRITE_FONT_NAME = 'font';
Blockly.MIXLY_TURTLE_WRITE_FONT_NUM = 'size';
Blockly.MIXLY_TURTLE_WRITE_FONT_TYPE = 'type';
Blockly.MIXLY_TURTLE_WRITE_FONT_TYPE_NORMAL = 'stanard';
Blockly.MIXLY_TURTLE_WRITE_FONT_TYPE_BOLD = 'bold';
Blockly.MIXLY_TURTLE_WRITE_FONT_TYPE_ITALIC = 'italic';
Blockly.MIXLY_TURTLE_WRITE_FONT_TYPE_BOLD_ITALIC = 'bold italic';
...
Blockly.MIXLY_ESP32_INOUT_ANALOG_READ_TOOLTIP = "Get the value of analog input (0 ~ 65535)";
...
Blockly.MIXLY_PYTHON_MATH_CONSTANT_PI_MP_TOOLTIP = "Approximate PI value (6 digits after decimal point)";
Blockly.MIXLY_PYTHON_MATH_CONSTANT_E_MP_TOOLTIP = "Approximate value of natural constants (6 decimal places are retained)";
...
Blockly.blynk_IOT_IR_SEND_TOOLTIP = 'Infrared sending address and content range are integers between 0 and 255';
...
Blockly.MIXLY_EMQX_PUBLISH_NEW = 'Publish message';
...
Blockly.MIXLY_CREATE_MQTT_CLIENT_AND_CONNECT = 'Create an MixIO client and connect'
...
Blockly.MIXLY_MIXGO_ESPNOW_INFO= 'Get source MAC address and signal strength';
...
Blockly.MIXLY_SET_VOLUME = 'set volume';
Blockly.MIXLY_SET_VOLUME_TOOLTIP = 'volume range 0-16';
Blockly.MIXLY_GET_VOLUME = 'get volume';
Blockly.MIXLY_PLAY_HINTS = 'play built-in prompt sound';
Blockly.MIXLY_PLAY_HINTS_TOOLTIP = 'built-in prompt sound range 0-47';
Blockly.MIXLY_BACKGROUND_MUSIC = 'background music';
Blockly.MIXLY_PROGRAM_BLOCK = 'wait until over';
Blockly.MIXLY_PLAY_TTS_TOOLTIP = 'background music range 0-15, 0 for no background music';
Blockly.MIXLY_GET_NTP = 'get network time';
...
Blockly.MIXLY_QR_CODE_ANALYSIS = "ergodic analysis";
...
Blockly.MIXLY_ANALYSIS_RESULT = 'analysis result';
...
Blockly.Msg.MPYTHON_DISPLAY_SHAPE_RECT_MESSAGE1 = 'OLED Screen %1 %2 %3 rectangle %4 x %5 y %6 width %7 height %8';
Blockly.Msg.MPYTHON_DISPLAY_HVLINE_MESSAGE1 = 'OLED Screen %1 %2 %3 line %4 x %5 y %6 length %7';
Blockly.Msg.mpython_display_line_MESSAGE1 = 'OLED Screen %1 %2 line %3 x1 %4 y1 %5 to x2 %6 y2 %7';
Blockly.MIXLY_REQUESTS_GET = 'request(GET)';
Blockly.MIXLY_GET_CURRENT_TIME = 'get current time';
Blockly.MIXLY_REQUESTS_ALL = 'all message';
Blockly.MIXLY_REQUESTS_MESSAGE = 'message content';
Blockly.MIXLY_REQUESTS_LEN = 'send-packet length';
Blockly.MIXLY_REQUESTS_GET_LEN = 'received-packet length';
Blockly.MIXLY_CONNECTTO = 'connect to';
Blockly.MIXLY_INIT_SUBSCRIBE = 'initialize and subscribe';
Blockly.MIXLY_OPEN_DEBUG = 'debug';
Blockly.MIXLY_USE_STRING = 'use string/tuple';
Blockly.MIXLY_PM25_SENSOR = 'PM2.5 dust sensor';
Blockly.MIXLY_GNSS_SENSOR = 'GNSS locator';
Blockly.MIXLY_GNSS_SENSOR_GET_TIME_TOOLTIP = 'return a list of satellite data time information，#0year,1month,2day,3week,4hour,5minute,6second,7microsecond';
Blockly.MIXLY_GNSS_SENSOR_GET_LOCATE_TOOLTIP = 'return a list of location information，#0longitude direction,1longitude,2latitude direction,3latitude,4height(m),5speed(m/s),6direction°';
Blockly.MIXLY_GNSS_SENSOR_GET_STATUS_TOOLTIP = 'return a list of status information，#0positioning is successful or not,1positioning mode,2number of satellites for positioning';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT1 = 'WIFI is connected';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT2 = 'The router successfully assigns an IP';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT3 = 'WIFI is disconnected';
Blockly.MIXLY_MIXBOT_SHOW_SCROLL_STRING_TOOLTIP = 'Single character static display, multi character scrolling display, non blocking when scrolling display';
Blockly.MIXLY_MIXBOT_AMBIENTBRIGHT = 'get ambient brightness';
Blockly.MIXLY_MIXBOT_SCREEN_ROTATE = 'set screen rotation';
Blockly.MIXLY_MIXBOT_MOTOR_STATUS = 'get motor status';
Blockly.MIXLY_MIXBOT_MOTOR_STATUS_TOOLTIP = 'Returns two tuples, corresponding to the left and right motor states, in order of mode, speed, power, and turns'
Blockly.MIXLY_MIXBOT_MOTOR_TURNS = 'turns';
Blockly.MIXLY_MIXBOT_MOVE_TOOLTIP = 'Power/speed parameter range -100~100, turns parameter range -32768~32767), negative sign represents reversal';
Blockly.MIXLY_MIXBOT_SOUND_LOUDNESS = 'get microphone volume';
...
Blockly.MIXLY_MIXBOT_MOTOR_EXTERN_TOOLTIP = 'Speed percentage range -100~100%, negative sign represents reversal';
Blockly.MIXLY_TRAFFIC_LIGHT= 'traffic lights';
Blockly.MIXLY_TRAFFIC_LIGHT_RED_ON= 'Red light on';
Blockly.MIXLY_TRAFFIC_LIGHT_RED_BLINK= 'Red light flashing';
Blockly.MIXLY_TRAFFIC_LIGHT_YELLOW_ON= 'Yellow light on';
Blockly.MIXLY_TRAFFIC_LIGHT_YELLOW_BLINK= 'Yellow light flashing';
Blockly.MIXLY_TRAFFIC_LIGHT_GREEN_ON= 'Green light on';
Blockly.MIXLY_TRAFFIC_LIGHT_GREEN_BLINK= 'Green light flashing';
Blockly.MIXLY_KNOB_POTENTIOMETER= 'Knob potentiometer';
Blockly.MIXLY_REFLECTION_BRIGHTNESS= 'Reflection brightness';
Blockly.MIXLY_ENVIRONMENT_BRIGHTNESS= 'Ambient brightness';
Blockly.MIXLY_SERVO_MOTOR= 'servo motor';
Blockly.MIXLY_RELATIVE = "relative";
Blockly.MIXLY_MIXBOT_SERVO_BLOCK_OR_NOT = "whether blocked";
Blockly.MIXLY_MIXBOT_SERVO_FINISH_OR_NOT = "whether finished rotating";
Blockly.MIXLY_MIXBOT_SERVO_SET_STOP_MODE = "Set stop mode";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_KEEP = "Holding Position";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_COAST = "Coast";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_BRAKE = "Resistance braking";
Blockly.MIXLY_MIXBOT_SERVO_TURN_DIRECTION = "Steering settings";
Blockly.MIXLY_MIXBOT_SERVO_NEAREST_PATH = "shortest path";
Blockly.MIXLY_MIXBOT_SERVO_RELATIVE_ORIGIN_PATH = "Set current position as the origin";
Blockly.MIXLY_MIXBOT_SERVO_LIKE_ENCODING_MOTOR = "like encoding motor";
Blockly.MIXLY_MIXBOT_SERVO_LIKE_ORDINARY_MOTOR = "like ordinary motor";
Blockly.MIXLY_MIXBOT_EXTERN_TOUCHED = "is touched";
Blockly.MIXLY_MIXBOT_SERVO_ABSOLUTE_ANGLE_TOOLTIP = "Absolute mode angle range 0~359";
