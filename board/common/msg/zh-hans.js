...
Blockly.MIXLY_MIXPY_ALGORITHM_FIND_PATH = '查找从当前位置是否有路直接通向未送走的同学家的位置，并且这条路之前没有尝试过';
Blockly.MIXLY_MIXPY_ALGORITHM_NEW_PATH = '有这样的位置';
Blockly.MIXLY_MIXPY_ALGORITHM_SET_PATH = '将当前位置记录为到达下一个同学家需要经过的位置';
Blockly.MIXLY_MIXPY_ALGORITHM_ADD_PATH = '将下一个同学家的位置加入路径';
