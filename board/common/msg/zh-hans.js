...
Blockly.MIXLY_WRITE_SPIFFS_FILE = '写入SPIFFS 文件';
...
Blockly.MIXLY_RGB_NUM_R_G_B_MP = "设置RGB彩灯模块指定灯的R值,G值,B值，灯号从0开始";
...
Blockly.MIXLY_ESP32C3_SENSOR_AHT_HUM_TOOLTIP = "获取湿度（相对湿度，0~100%）";
...
Blockly.MIXLY_ESP32_INOUT_ANALOG_READ_TOOLTIP = "获取模拟输入的值（0~65535）";
...
Blockly.MIXLY_PYTHON_MATH_CONSTANT_PI_MP_TOOLTIP = "圆周率常数的近似值（保留小数点后6位）";
Blockly.MIXLY_PYTHON_MATH_CONSTANT_E_MP_TOOLTIP = "自然常数的近似值（保留小数点后6位）";
...
Blockly.blynk_IOT_IR_SEND_TOOLTIP = '红外发送地址与内容范围均为0~255之间的整数';
Blockly.DISPLAY = '显示屏';
Blockly.OLED = 'OLED';
...
Blockly.MIXLY_EMQX_PUBLISH_NEW = '发布消息';
...
Blockly.MIXLY_EMQX_IS_CONNECT = '连接成功';
...
Blockly.MIXLY_CREATE_MQTT_CLIENT_AND_CONNECT = '创建MixIO客户端并连接';
...
Blockly.MIXLY_GAME_ISBARRIER="侧有障碍";
...
Blockly.MIXLY_SET_VOLUME = '设置音量';
Blockly.MIXLY_SET_VOLUME_TOOLTIP = '音量范围0-16';
Blockly.MIXLY_GET_VOLUME = '获取音量';
Blockly.MIXLY_PLAY_HINTS = '播放内置提示音';
Blockly.MIXLY_PLAY_HINTS_TOOLTIP = '内置提示音范围0-47';
Blockly.MIXLY_BACKGROUND_MUSIC = '背景音乐';
Blockly.MIXLY_PROGRAM_BLOCK = '等待播放结束';
Blockly.MIXLY_PLAY_TTS_TOOLTIP = '背景音乐范围0-15, 0为无背景音乐';
Blockly.MIXLY_GET_NTP = '获取网络时间';
...
Blockly.MIXLY_ALL_CODE_ANALYSIS = '遍历解析';
...
Blockly.MIXLY_ANALYSIS_RESULT = '解析结果';
...
Blockly.MIXLY_MIXPY_ALGORITHM_NO_LEFT = '所有同学都被送回家了';
Blockly.MIXLY_MIXPY_ALGORITHM_PRINT_PATH = '显示路线';
Blockly.MIXLY_MIXPY_ALGORITHM_PRINT_PATH2 = '显示路径';
Blockly.MIXLY_MIXPY_ALGORITHM_FIRST_BOOK = '取第一本书';
Blockly.MIXLY_MIXPY_ALGORITHM_NO_RING = '门禁没响';
Blockly.MIXLY_MIXPY_ALGORITHM_NEXT_BOOK = '取下一本书';
Blockly.MIXLY_MIXPY_ALGORITHM_PRINT_BOOK = '输出书号';
Blockly.MIXLY_MIXPY_ALGORITHM_NUMBER_ZERO = '计数器赋值为0';
Blockly.MIXLY_MIXPY_ALGORITHM_NUMBER_ADD = '计数器+1';
Blockly.MIXLY_MIXPY_ALGORITHM_PRINT_NUMBER = '输出计数器大小';
Blockly.MIXLY_MIXPY_ALGORITHM_ALL_BOOKS = '二分法开始';
Blockly.MIXLY_MIXPY_ALGORITHM_ALL_BOOKS2 = '顺序法开始';
Blockly.MIXLY_MIXPY_ALGORITHM_TWO_LEFT= '书架剩余书籍≥2本';
Blockly.MIXLY_MIXPY_ALGORITHM_DIVIDE_BOOKS = '把书堆分成两半';
Blockly.MIXLY_MIXPY_ALGORITHM_GET_HALF_BOOKS = '取出前一堆书';
Blockly.MIXLY_MIXPY_ALGORITHM_CHECK_HALF_BOOKS = '检查前一堆书是否会使得门铃响起';
Blockly.MIXLY_MIXPY_ALGORITHM_DELETE_BOOKS = '去除前一堆书';
Blockly.MIXLY_MIXPY_ALGORITHM_DELETE_BOOKS2 = '去除后一堆书';
Blockly.MIXLY_MIXPY_ALGORITHM_USE_SEQUENCE = '开始计算顺序查找法次数';
...
Blockly.MIXLY_REQUESTS_GET = '发起请求';
Blockly.MIXLY_GET_CURRENT_TIME = '获取当前时间';
Blockly.MIXLY_REQUESTS_ALL = '全部内容';
Blockly.MIXLY_REQUESTS_MESSAGE = '消息内容';
Blockly.MIXLY_REQUESTS_LEN = '发送包长度';
Blockly.MIXLY_REQUESTS_GET_LEN = '接收包长度';
Blockly.MIXLY_CONNECTTO = '连接到';
Blockly.MIXLY_INIT_SUBSCRIBE = '初始化并订阅';
Blockly.MIXLY_OPEN_DEBUG = '打开调试';
Blockly.MIXLY_USE_STRING_TUPLE = '使用字符串/元组';
Blockly.MIXLY_PM25_SENSOR = 'PM2.5粉尘传感器';
Blockly.MIXLY_GNSS_SENSOR = 'GNSS定位器';
Blockly.MIXLY_GNSS_SENSOR_GET_TIME_TOOLTIP = '返回卫星数据时间信息列表，#0年,1月,2日,3星期,4时,5分,6秒,7微秒';
Blockly.MIXLY_GNSS_SENSOR_GET_LOCATE_TOOLTIP = '返回定位信息列表，#0经度方向,1经度值,2纬度方向,3纬度值,4海拔m,5速度m/s,6航向°';
Blockly.MIXLY_GNSS_SENSOR_GET_STATUS_TOOLTIP = '返回状态信息列表，#0是否定位成功,1定位模式,2定位用卫星数量';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT1 = 'WIFI已连接';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT2 = '路由器成功分配IP';
Blockly.MIXLY_ESP32_WIFI_CONNECTION_EVENT3 = 'WIFI断开';
Blockly.MIXLY_MIXBOT_SHOW_SCROLL_STRING_TOOLTIP = '单字符静态显示，多字符滚动显示，滚动显示无阻塞';
Blockly.MIXLY_MIXBOT_AMBIENTBRIGHT = '获取环境亮度';
Blockly.MIXLY_MIXBOT_SCREEN_ROTATE = '设置屏幕旋转';
Blockly.MIXLY_MIXBOT_MOTOR_STATUS = '获取电机状态';
Blockly.MIXLY_MIXBOT_MOTOR_STATUS_TOOLTIP = '返回两个元组，分别对应左右两个电机状态，依次为模式，速度，功率，圈数'
Blockly.MIXLY_MIXBOT_MOTOR_TURNS = '圈数';
Blockly.MIXLY_MIXBOT_MOVE_TOOLTIP = '功率/速度参数范围-100~100, 圈数参数范围-32768~32767)，负号代表反转';
Blockly.MIXLY_MIXBOT_SOUND_LOUDNESS = '获取麦克风音量';
Blockly.MIXLY_MIXBOT_LINE_SENSOR_CALIBRATE_WHITE = '校正白色';
Blockly.MIXLY_MIXBOT_LINE_SENSOR_CALIBRATE_BLACK = '校正黑色';
Blockly.MIXLY_MIXBOT_LINE_SENSOR_CALIBRATE_RESET = '恢复出厂';
...
Blockly.MIXLY_MIXBOT_MOTOR_EXTERN_TOOLTIP = '速度百分比范围-100~100%，负号代表反转';
Blockly.MIXLY_TRAFFIC_LIGHT= '交通灯';
Blockly.MIXLY_TRAFFIC_LIGHT_RED_ON= '红灯亮';
Blockly.MIXLY_TRAFFIC_LIGHT_RED_BLINK= '红灯闪';
Blockly.MIXLY_TRAFFIC_LIGHT_YELLOW_ON= '黄灯亮';
Blockly.MIXLY_TRAFFIC_LIGHT_YELLOW_BLINK= '黄灯闪';
Blockly.MIXLY_TRAFFIC_LIGHT_GREEN_ON= '绿灯亮';
Blockly.MIXLY_TRAFFIC_LIGHT_GREEN_BLINK= '绿灯闪';
Blockly.MIXLY_KNOB_POTENTIOMETER= '旋钮电位器';
Blockly.MIXLY_REFLECTION_BRIGHTNESS= '反射亮度';
Blockly.MIXLY_ENVIRONMENT_BRIGHTNESS= '环境亮度';
Blockly.MIXLY_SERVO_MOTOR= '伺服电机';
Blockly.MIXLY_RELATIVE = "相对";
Blockly.MIXLY_MIXBOT_SERVO_BLOCK_OR_NOT = "是否堵住";
Blockly.MIXLY_MIXBOT_SERVO_FINISH_OR_NOT = "是否转完";
Blockly.MIXLY_MIXBOT_SERVO_SET_STOP_MODE = "设置停止模式";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_KEEP = "保持位置";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_COAST = "惯性滑行";
Blockly.MIXLY_MIXBOT_SERVO_STOP_MODE_BRAKE = "阻力制动";
Blockly.MIXLY_MIXBOT_SERVO_TURN_DIRECTION = "转向设置";
Blockly.MIXLY_MIXBOT_SERVO_NEAREST_PATH = "最短路径";
Blockly.MIXLY_MIXBOT_SERVO_RELATIVE_ORIGIN_PATH = "设置当前位置为原点";
Blockly.MIXLY_MIXBOT_SERVO_LIKE_ENCODING_MOTOR = "类编码电机";
Blockly.MIXLY_MIXBOT_SERVO_LIKE_ORDINARY_MOTOR = "类普通电机";
Blockly.MIXLY_MIXBOT_EXTERN_TOUCHED = "被触碰";
Blockly.MIXLY_MIXBOT_SERVO_ABSOLUTE_ANGLE_TOOLTIP = "绝对角度运行模式角度范围0~359";
Blockly.MIXLY_MIXBOT_SERVO_RELATIVE_ANGLE_TOOLTIP = "相对角度运行模式角度范围-8388607~8388607";
Blockly.MIXLY_MIXBOT_EXTERN_GET_ADDR = "扫描序号";
Blockly.MIXLY_MIXBOT_EXTERN_SET_ADDR = "修改序号";
Blockly.MIXPY_REQUESTS_GET_RESULT = '并获取相应结果';