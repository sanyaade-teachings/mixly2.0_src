...
Blockly.Blocks['sensor_ltr381_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.HTML_COLOUR+MSG.catSensor+" LTR308RGB")
            .setCheck("var");
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
            [Blockly.MIXLY_GET+Blockly.Msg.HTML_COLOUR, "[2]"],
            [Blockly.MIXLY_GET+Blockly.MIXLY_IR_STRENGTH, "[1]"],
            [Blockly.MIXLY_GET+Blockly.MIXLY_LIGHT_STRENGTH, "[0]"],
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks.mixbot_button_extern_get_value = {
    init: function () {
      ...
      this.appendDummyInput()
          ...
          .appendField(new Blockly.FieldDropdown([
            [Blockly.mixpy_PL_TEXT_TOP, '[0]'],
            [Blockly.mixpy_PL_TEXT_BOTTOM, '[1]'],
            [Blockly.Msg.TEXT_TRIM_LEFT, '[2]'],
            [Blockly.Msg.TEXT_TRIM_RIGHT, '[3]'],
            [Blockly.mixpy_PL_TEXT_CENTER, '[4]']
            ]), "num");            
      this.appendDummyInput()
    ...
    init: function () {
      ...
      this.appendDummyInput()
          ...
          .appendField(new Blockly.FieldDropdown([
            ...
            ["RGB"+Blockly.MIXLY_MICROBIT_TYPE_TUPLE, '[1]'],
            [Blockly.MIXLY_ENVIRONMENT_BRIGHTNESS, '[2]'],
            [Blockly.MIXLY_REFLECTION_BRIGHTNESS, '[3]'],
            [Blockly.MIXLY_ALL, '']
            ]), "color");    
      this.setOutput(true,Boolean);
      this.setInputsInline(true);
