...
profile["MixGo CE"] = {
    ...
    digital_pin: profile.generate([ '1-2','4-7','9-12','17-18','43-44']),
    input_pin: profile.generate(['1-2','4-7','9-12','17-18','43-44']),
    output_pin: profile.generate(['1-2','4-7','9-12','17-18','43-44']),
    pwm_input: profile.generate(['1-2','4-7','9-12','17-18','43-44'], 'pwm', 'pwm'),
    analog_input: profile.generate(['1-2','4-7','9-12','17-18','43-44'], 'adc', 'adc'),
    pwm_output: profile.generate(['1-2','4-7','9-12','17-18','43-44'], 'pwm', 'pwm'),
    analog_output: profile.generate(['1-2','4-7','9-12','17-18','43-44'], 'adc', 'adc'),
    espnow_channel: profile.generate([ '0-13']),
    haskylens_model: profile.generate([ '0-4']),    
    digital: profile.generate(['1-2','4-7','9-12','17-18','43-44'], 'pin', 'pin'),
    pwm_pin: profile.generate(['1-2','4-7','9-12','17-18','43-44']),
    pwm: profile.generate([ '1-2','4-7','9-12','17-18','43-44' ], 'pwm', 'pwm'),
    analog_pin: profile.generate([  '1-2','4-7','9-12','17-18' ]),
    analog: profile.generate([  '1-2','4-7','9-12','17-18' ], 'adc', 'adc'),
    dac_pin: profile.generate([ '17-18' ]),
    dac: profile.generate([ '17-18' ], 'dac', 'dac'),
    touch: profile.generate([ '1-2','4-7','9-12'], 'tc', 'tc'),
    touch_pin: profile.generate([  '1-2','4-7','9-12' ]),
