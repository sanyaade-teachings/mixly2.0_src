...
Blockly.Python.ce_go_get_led_bright = function() {
    var op = Blockly.Python.valueToCode(this,'led', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import_ce_go_car'] = 'from ce_go import car';
...
Blockly.Python.ce_go_get_led_state = function() {
    var op = Blockly.Python.valueToCode(this,'led', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import_ce_go_car'] = 'from ce_go import car';
...
Blockly.Python.ce_go_led_brightness = function() {
    var op = Blockly.Python.valueToCode(this,'led', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['import_ce_go_car'] = 'from ce_go import car';
...
Blockly.Python.ce_go_hall_attachInterrupt = function () {
...
Blockly.Python.ce_go_hall_initialize = function () {
    var dropdown_mode = this.getFieldValue('mode');
...
Blockly.Python.ce_go_hall_data = function() {
    var dropdown_mode = this.getFieldValue('mode');
    var args = this.getFieldValue('args');
    Blockly.Python.definitions_['import_ce_go_hall_'+dropdown_mode] = 'from ce_go import hall_'+dropdown_mode;
...
Blockly.Python.ce_go_pin_near_line = function(){
...
Blockly.Python.ce_go_pin_near = function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_ce_go_hall'] = 'from ce_go import car';
...
Blockly.Python.ce_go_pin_near_state_change = function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_ce_go_hall'] = 'from ce_go import car';
...
Blockly.Python.ce_go_pin_light = function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_ce_go_hall'] = 'from ce_go import car';
