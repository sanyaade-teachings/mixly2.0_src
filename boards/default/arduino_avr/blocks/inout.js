...
Blockly.Blocks['inout_pinMode'] = {
    init: function () {
        ...
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PINMODE)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_STAT)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_PINMODEIN, "INPUT"], [Blockly.Msg.Lang.MIXLY_PINMODEOUT, "OUTPUT"], [Blockly.Msg.Lang.MIXLY_PINMODEPULLUP, "INPUT_PULLUP"]]), "MODE")
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_pinMode);
        this.wiki = {
            'zh-hans': {
...
Blockly.Blocks.inout_buildin_led = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_BUILDIN_LED)
            .appendField(Blockly.Msg.Lang.MIXLY_STAT)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_ON, "HIGH"], [Blockly.Msg.Lang.MIXLY_OFF, "LOW"]]), "STAT");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks.OneButton_interrupt = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.ONEBUTTON + " " + Blockly.Msg.Lang.MIXLY_PIN)
            .setCheck(Number);
        this.appendDummyInput("")
...
Blockly.Blocks.controls_attachInterrupt = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_ATTACHINTERRUPT_PIN)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_MODE)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_RISING, "RISING"], [Blockly.Msg.Lang.MIXLY_FALLING, "FALLING"], [Blockly.Msg.Lang.MIXLY_CHANGE, "CHANGE"]]), "mode");
        this.appendStatementInput('DO')
            .appendField(Blockly.Msg.Lang.MIXLY_DO);
...
Blockly.Blocks.controls_detachInterrupt = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_DETACHINTERRUPT_PIN)
            .setCheck(Number);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_DETACHINTERRUPT);
...
Blockly.Blocks.controls_attachPinInterrupt = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_ATTACHPININTERRUPT_PIN)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_MODE)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_RISING, "RISING"], [Blockly.Msg.Lang.MIXLY_FALLING, "FALLING"], [Blockly.Msg.Lang.MIXLY_CHANGE, "CHANGE"]]), "mode");
...
Blockly.Blocks.controls_detachPinInterrupt = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_DETACHPININTERRUPT_PIN)
            .setCheck(Number);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_DETACHINTERRUPT);
...
Blockly.Blocks.inout_pulseIn = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PULSEIN)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_PULSEIN_STAT)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_HIGH, "HIGH"], [Blockly.Msg.Lang.MIXLY_LOW, "LOW"]]), "STAT");
        this.setOutput(true, Number);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_pulseIn);
...
Blockly.Blocks.inout_pulseIn2 = {
    init: function () {
        ...
        this.appendValueInput("TIMEOUT", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PULSEIN_TIMEOUT)
            .setCheck(Number);
        this.setInputsInline(true);
        this.setOutput(true, Number);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_pulseIn2);
        this.setHelpUrl("https://mixly.readthedocs.io/zh_CN/latest/arduino/02.Input-Output.html#id33");
        this.wiki = {
            'zh-hans': {
                page: ['Arduino AVR', '输入输出', '脉冲长度']
...
Blockly.Blocks.inout_shiftout = {
    init: function () {
        ...
        this.appendValueInput("PIN1", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_DATAPIN)
            .setCheck(Number);
        this.appendValueInput("PIN2", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_CLOCKPIN)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_BITORDER)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_MSBFIRST, "MSBFIRST"], [Blockly.Msg.Lang.MIXLY_LSBFIRST, "LSBFIRST"]]), "ORDER");
        ...
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_INOUT_shiftout);
...
Blockly.Blocks.ESP32touchButton = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField("ESP32" + Blockly.Msg.Lang.MIXLY_ESP32_TOUCH + Blockly.Msg.Lang.ONEBUTTON + " " + Blockly.Msg.Lang.MIXLY_PIN)
            .setCheck(Number);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_MODE)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_CLICK, "attachClick"], [Blockly.Msg.Lang.MIXLY_DOUBLE_CLICK, "attachDoubleClick"], [Blockly.Msg.Lang.MIXLY_LONG_PRESS_START, "attachLongPressStart"], [Blockly.Msg.Lang.MIXLY_DURING_LONG_PRESS, "attachDuringLongPress"], [Blockly.Msg.Lang.MIXLY_LONG_PRESS_END, "attachLongPressStop"]]), "mode");
...
Blockly.Blocks.inout_soft_analog_write = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_SOFT_ANALOGWRITE_PIN)
            .setCheck(Number);
        this.appendValueInput("NUM", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_VALUE2)
            .setCheck(Number);
...
Blockly.Blocks.inout_cancel_soft_analog_write = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_CANCEL_SOFT_ANALOGWRITE_PIN)
            .setCheck(Number);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_CANCEL_SOFT_ANALOGWRITE_PIN);
        this.setHelpUrl("");
    }
};
...
Blockly.Blocks.ADS1015_setGain = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendDummyInput("").appendField(Blockly.Msg.Lang.MIXLY_SETTING).appendField(Blockly.Msg.Lang.ADS1015_setGain);
...
Blockly.Blocks.ADS1015_Get_Value = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendDummyInput("").appendField("ADS1015" + Blockly.Msg.Lang.ADS1015_Get_Value);
...
Blockly.Blocks.PCF8591T = {
    init: function () {
        this.setColour(Blockly.Msg['BASE_HUE']);
        this.appendDummyInput("").appendField("PCF8591T" + Blockly.Msg.Lang.ADS1015_Get_Value);
