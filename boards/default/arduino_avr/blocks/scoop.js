...
Blockly.Blocks['SCoopTask'] = {
    init: function () {
        ...
        this.appendStatementInput("loop")
            .appendField(Blockly.Msg.Lang.MIXLY_CONTROL_SCoop_loop)
            .setCheck(null);
        this.setColour(Blockly.Msg['SCOOP_HUE']);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SCOOP);
...
Blockly.Blocks['SCoop_yield'] = {
    init: function () {
        this.setColour(Blockly.Msg['SCOOP_HUE']);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_CONTROL_SCoop_yield);
        this.setPreviousStatement(false, null);
        this.setNextStatement(false, null);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SCOOP_YIELD);
        this.setHelpUrl("https://mixly.readthedocs.io/zh_CN/latest/arduino/03.Control.html#scoop-task");
        this.wiki = {
            'zh-hans': {
                page: ['Arduino AVR', '控制', 'SCoop Task']
...
Blockly.Blocks['SCoop_sleep'] = {
    init: function () {
        this.setColour(Blockly.Msg['SCOOP_HUE']);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_CONTROL_SCoop_sleep);
