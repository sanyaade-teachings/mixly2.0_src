...
Blockly.Blocks['serial_begin'] = {
    init: function () {
        ...
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SERIAL_BEGIN);
    }
};
...
Blockly.Blocks['serial_write'] = {
    init: function () {
        ...
        this.appendValueInput("CONTENT", String)
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_WRITE);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.Msg.Lang.TEXT_WRITE_TOOLTIP);
    }
};
...
Blockly.Blocks['serial_print'] = {
    init: function () {
        ...
        this.appendValueInput("CONTENT", String)
            ...
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_PRINT_INLINE, "print"], [Blockly.Msg.Lang.TEXT_PRINT_Huanhang_TOOLTIP, "println"]]), "new_line");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks['serial_println'] = {
    init: function () {
        ...
        this.appendValueInput("CONTENT", String)
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_PRINT)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.TEXT_PRINT_Huanhang_TOOLTIP, "println"], [Blockly.Msg.Lang.MIXLY_PRINT_INLINE, "print"]]), "new_line");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.Msg.Lang.TEXT_PRINT_TOOLTIP);
    }
...
Blockly.Blocks['serial_print_num'] = {
    init: function () {
        ...
        this.appendDummyInput()
            ...
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_PRINT)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_PRINT_INLINE, "print"], [Blockly.Msg.Lang.TEXT_PRINT_Huanhang_TOOLTIP, "println"]]), "new_line")
            .appendField(Blockly.Msg.Lang.MIXLY_NUMBER);
        this.appendValueInput("CONTENT", Number)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MATH_HEX, "HEX"], [Blockly.Msg.Lang.MATH_BIN, "BIN"], [Blockly.Msg.Lang.MATH_OCT, "OCT"], [Blockly.Msg.Lang.MATH_DEC, "DEC"]]), "STAT")
            .setCheck(Number);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setInputsInline(true);
...
Blockly.Blocks['serial_available'] = {
    init: function () {
        ...
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_SERIAL_AVAILABLE);
    }
};
...
Blockly.Blocks['serial_readstr_until'] = {
    init: function () {
        ...
        this.appendValueInput("CONTENT", Number)
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_READSTR_UNTIL)
            .setCheck(Number);
        this.setInputsInline(true);
        this.setOutput(true, String);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SERIAL_READSTRUNITL.replace('%1', Blockly.Arduino.valueToCode(this, 'CONTENT', Blockly.Arduino.ORDER_ATOMIC)));
    }
};
...
Blockly.Blocks['serial_parseInt_Float'] = {
    init: function () {
        ...
        this.setTooltip(function () {
            ...
            var TOOLTIPS = {
                'parseInt': Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_SERIAL_READ_INT,
                'parseFloat': Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_SERIAL_READ_FLOAT
            };
            return TOOLTIPS[op];
        });
    }
...
Blockly.Blocks['serial_flush'] = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_FLUSH);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SERIAL_FLUSH);
    }
};
...
Blockly.Blocks['serial_event'] = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown(profile.default.serial_select), "serial_select")
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_EVENT);
        this.appendStatementInput('DO')
            .appendField(Blockly.Msg.Lang.MIXLY_DO);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_SERIALEVENT);
    }
};