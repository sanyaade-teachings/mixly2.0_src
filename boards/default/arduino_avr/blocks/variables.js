...
Blockly.Blocks['variables_declare'] = {
    ...
    init: function () {
        ...
        this.appendValueInput('VALUE', null)
            ...
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_GLOBAL_VARIABLE, "global_variate"], [Blockly.Msg.Lang.MIXLY_LOCAL_VARIABLE, "local_variate"]]), "variables_type")
...
Blockly.Blocks['variables_change'] = {
    init: function () {
        ...
        this.setOutput(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_TOOLTIP_VARIABLES_CHANGE);
    }
};
