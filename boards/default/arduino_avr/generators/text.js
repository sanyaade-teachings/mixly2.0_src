...
Blockly.Arduino.forBlock['text'] = function () {
    // Text value.
...
Blockly.Arduino.forBlock['text_char'] = function () {
    var code = '\'' + this.getFieldValue('TEXT') + '\'';
    return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.forBlock['text_join'] = function () {
    // Text value.
...
Blockly.Arduino.forBlock['text_to_number'] = function () {
...
Blockly.Arduino.forBlock['ascii_to_char'] = function () {
...
Blockly.Arduino.forBlock['char_to_ascii'] = function () {
    var charvalue = '\'' + this.getFieldValue('TEXT') + '\'';
    return ['toascii(' + charvalue + ')', Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.forBlock['number_to_text'] = function () {
    var towhat = this.getFieldValue('TOWHAT');
...
Blockly.Arduino.forBlock['text_length'] = function () {
...
Blockly.Arduino.forBlock['text_char_at'] = function () {
    var str = Blockly.Arduino.valueToCode(this, 'VAR', Blockly.Arduino.ORDER_ATOMIC) || '\"\"';
...
Blockly.Arduino.forBlock['text_equals_starts_ends'] = function () {
...
Blockly.Arduino.forBlock['text_compareTo'] = function () {
    var str1 = 'String(' + (Blockly.Arduino.valueToCode(this, 'STR1', Blockly.Arduino.ORDER_ATOMIC) || '\"\"') + ')';
    var str2 = 'String(' + (Blockly.Arduino.valueToCode(this, 'STR2', Blockly.Arduino.ORDER_ATOMIC) || '\"\"') + ')';
    return [str1 + '.compareTo(' + str2 + ')', Blockly.Arduino.ORDER_ATOMIC];
};
//小数获取有效位
Blockly.Arduino.forBlock['decimal_places'] = function () {
...
//截取字符串
Blockly.Arduino.forBlock['substring'] = function () {
...
//字符串转化为大小写
Blockly.Arduino.forBlock['letter_conversion'] = function () {
...
//字符串变量替换
Blockly.Arduino.forBlock['data_replacement'] = function () {
    var String = Blockly.Arduino.valueToCode(this, 'String', Blockly.Arduino.ORDER_ATOMIC);
...
//消除非可视字符
Blockly.Arduino.forBlock['eliminate'] = function () {
    var String = Blockly.Arduino.valueToCode(this, 'String', Blockly.Arduino.ORDER_ATOMIC);
...
//检测是否以特定字符串开头或结尾
Blockly.Arduino.forBlock['first_and_last'] = function () {
    var type = this.getFieldValue('type');
    var String = Blockly.Arduino.valueToCode(this, 'String', Blockly.Arduino.ORDER_ATOMIC);
...
Blockly.Arduino.forBlock['text_join2'] = function () {
...
//字符串转长整数
Blockly.Arduino.forBlock['String_to_Long_Integer'] = function() {
