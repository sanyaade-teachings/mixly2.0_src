...
Blockly.Blocks.HT16K33_TEXT={
  init:function(){
    ...
    .appendField(Blockly.Msg.Lang.MIXLY_MAX7219_PUTSTR); 
...
Blockly.Blocks.HT16K33_POS = {
  init: function() {
    ...
    [Blockly.Msg.Lang.MIXLY_4DIGITDISPLAY_ON, "LED_ON"],
    [Blockly.Msg.Lang.MIXLY_4DIGITDISPLAY_OFF, "LED_OFF"]
    ];
    this.setColour(Blockly.Msg['DISPLAY_HUE']);
    this.appendDummyInput("")
    ...
    .setCheck(Number)
    .setAlign(Blockly.ALIGN_RIGHT)
    .appendField(Blockly.Msg.Lang.MIXLY_DISPLAY_MATRIX_X);
    this.appendValueInput("YVALUE")
    .setCheck(Number)
    .setAlign(Blockly.ALIGN_RIGHT)
    .appendField(Blockly.Msg.Lang.MIXLY_DISPLAY_MATRIX_Y);
    this.appendDummyInput("")
    .setAlign(Blockly.ALIGN_RIGHT)
    .appendField(Blockly.Msg.Lang.MIXLY_DISPLAY_MATRIX_SHOWPOINT )
...
Blockly.Blocks.HT16K33_DisplayChar = {
  init: function() {
    ...
    .setCheck(Number)
    .setAlign(Blockly.ALIGN_RIGHT)
    .appendField(Blockly.Msg.Lang.MIXLY_DISPLAY_MATRIX_PICARRAY);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip();
  }
...
Blockly.Blocks.HT16K33_LedArray = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_HUE']);
    this.appendDummyInput("")
    .appendField(Blockly.Msg.Lang.MIXLY_DISPLAY_MATRIX_ARRAYVAR)
...
Blockly.Blocks.sensor_mixgo_pin_near = {
  init: function(){
    this.setColour(Blockly.Msg['SENSOR_HUE']);
    this.appendDummyInput()
    .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.TEXT_TRIM_LEFT, "34"], [Blockly.Msg.Lang.TEXT_TRIM_RIGHT, "36"]]), "direction")
...
Blockly.Blocks.mixGo_led = {
  init: function() {
    ...
    .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_LEFT,"0"],[Blockly.Msg.Lang.MIXLY_RIGHT,"5"]]), 'STAT');
