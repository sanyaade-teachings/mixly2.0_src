...
En.ESP32_CONFIG_TEMPLATE = goog.get(path.join(templateDirPath, 'board-config-message.html'));
...
En.ESP32_CONFIG_MESSAGE_CPU_FREQ = XML.render(En.ESP32_CONFIG_TEMPLATE, {
    title: 'CPU Frequency',
...
En.ESP32_CONFIG_MESSAGE_FLASH_FREQ = XML.render(En.ESP32_CONFIG_TEMPLATE, {
...
En.ESP32_CONFIG_MESSAGE_LOOP_CORE = XML.render(En.ESP32_CONFIG_TEMPLATE, {
...
En.ESP32_CONFIG_MESSAGE_EVENTS_CORE = XML.render(En.ESP32_CONFIG_TEMPLATE, {
    title: 'Events Run On',
...
En.ESP32_CONFIG_MESSAGE_CDC_ON_BOOT = XML.render(En.ESP32_CONFIG_TEMPLATE, {
...
En.ESP32_CONFIG_MESSAGE_MSC_ON_BOOT = XML.render(En.ESP32_CONFIG_TEMPLATE, {
...
En.ESP32_CONFIG_MESSAGE_DFU_ON_BOOT = XML.render(En.ESP32_CONFIG_TEMPLATE, {
