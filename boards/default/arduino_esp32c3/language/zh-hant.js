...
ZhHant.ESP32_CONFIG_TEMPLATE = goog.get(path.join(templateDirPath, 'board-config-message.html'));
...
ZhHant.ESP32_CONFIG_MESSAGE_CPU_FREQ = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
    title: 'CPU時鐘頻率',
...
ZhHant.ESP32_CONFIG_MESSAGE_FLASH_FREQ = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
    title: '閃存頻率',
...
ZhHant.ESP32_CONFIG_MESSAGE_LOOP_CORE = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
    title: 'Arduino迴圈覈心',
...
ZhHant.ESP32_CONFIG_MESSAGE_EVENTS_CORE = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
    title: 'Arduino事件覈心',
...
ZhHant.ESP32_CONFIG_MESSAGE_CDC_ON_BOOT = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
...
ZhHant.ESP32_CONFIG_MESSAGE_MSC_ON_BOOT = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
...
ZhHant.ESP32_CONFIG_MESSAGE_DFU_ON_BOOT = XML.render(ZhHant.ESP32_CONFIG_TEMPLATE, {
