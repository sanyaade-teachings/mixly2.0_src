...
ZhHans.ESP32_CONFIG_TEMPLATE = goog.get(path.join(templateDirPath, 'board-config-message.html'));
...
ZhHans.ESP32_CONFIG_MESSAGE_CPU_FREQ = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
    title: 'CPU时钟频率',
...
ZhHans.ESP32_CONFIG_MESSAGE_FLASH_FREQ = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
    title: '闪存频率',
...
ZhHans.ESP32_CONFIG_MESSAGE_LOOP_CORE = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
    title: 'Arduino循环核心',
...
ZhHans.ESP32_CONFIG_MESSAGE_EVENTS_CORE = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
    title: 'Arduino事件核心',
...
ZhHans.ESP32_CONFIG_MESSAGE_CDC_ON_BOOT = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
...
ZhHans.ESP32_CONFIG_MESSAGE_MSC_ON_BOOT = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
...
ZhHans.ESP32_CONFIG_MESSAGE_DFU_ON_BOOT = XML.render(ZhHans.ESP32_CONFIG_TEMPLATE, {
