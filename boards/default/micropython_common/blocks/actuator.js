    ...
    init: function() {
        ...
        this.appendDummyInput("")
            .appendField(new Blockly.FieldDropdown([
                ...
                [Blockly.Msg.Lang.MIXLY_ESP32_TOGGLE, "-1"]
            ]), "flag");
        this.setOutput(true);
...
Blockly.Blocks.actuator_led_brightness = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setInputsInline(true);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_LED_SETBRIGHT);
  }
};
...
Blockly.Blocks.esp32_mixgo_music_play_list_show = {
    init: function () {
        ...
        //     .appendField(Blockly.Msg.Lang.MIXLY_ESP32_MIXGO_MUSIC_SHOW_IN);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_MIXGO_MUSIC_PLAY_TONE);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_PLAYSHOW)
    }
}
//RGB
