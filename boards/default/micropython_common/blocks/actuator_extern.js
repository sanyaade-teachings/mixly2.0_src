...
Blockly.Blocks.esp32_music_pitch_init = {
    init: function () {
        ...
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_MIDI)
...
Blockly.Blocks.esp32_music_play_list = {
    init: function () {
        ...
        this.appendValueInput('LIST')
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_PLAY_LISTS)
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_PLAY_LISTS);
...
Blockly.Blocks.esp32_music_set_tempo_extern = {
    init: function () {
        ...
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_SET_TEMPO);
    }
}
...
Blockly.Blocks.esp32_music_get_tempo_extern = {
    init: function () {
        ...
        this.appendValueInput('SUB')
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_Get_current_tempo)
        this.setOutput(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_GET_TEMPO);
    }
}
...
Blockly.Blocks.esp32_music_reset_extern = {
    init: function () {
        ...
        this.appendValueInput('SUB')
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_Reset_music)
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_RESET);
    }
}
...
Blockly.Blocks.actuator_extern_led_bright = {
  init: function() {
    ...
    this.appendDummyInput()
        ...
        .appendField(Blockly.Msg.Lang.MIXLY_EXTERN_LED)
    this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PIN)
            .setCheck(Number);
    ...
    this.setNextStatement(true, null);
    this.setInputsInline(true);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_LED_SETONOFF);
  }
};
...
Blockly.Blocks.actuator_extern_get_led_bright = {
  init: function() {
    ...
    this.setOutput(true);
    this.setInputsInline(true);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_LED_GETONOFF);
  }
};
...
Blockly.Blocks.actuator_extern_led_brightness = {
  init: function() {
    ...
    this.setNextStatement(true, null);
    this.setInputsInline(true);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_LED_SETBRIGHT);
  }
};
...
Blockly.Blocks.servo_init = {
    init: function() {
        ...
        this.appendValueInput("VAR")
            .appendField(Blockly.Msg.Lang.MIXLY_SETUP+Blockly.Msg.Lang.MIXLY_SERVO)
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PIN )
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
...
Blockly.Blocks.servo_speed_360 = {
    init: function() {
        ...
        this.appendValueInput("SPEED", Number)
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.Msg.Lang.MIXLY_SETTING+Blockly.Msg.Lang.blockpy_turtle_rotate+Blockly.Msg.Lang.MIXLY_SPEED+" (-10~10)");
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_SERVO_360_TOOLTIP);
    }
};
...
Blockly.Blocks.actuator_ms32006_dcmotor = {
  ...
  this.appendDummyInput()
      .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_Direction)
        ...
        [Blockly.Msg.Lang.CLOCKWISE, "ms32006.MOT_CW"],
        [Blockly.Msg.Lang.ANTI_CLOCKWISE, "ms32006.MOT_CCW"],
        [Blockly.Msg.Lang.MOTOR_N, "ms32006.MOT_N"],
        [Blockly.Msg.Lang.MOTOR_P, "ms32006.MOT_P"]
        ]), "direction");
...
Blockly.Blocks.actuator_neopixel_rgb = {
    init: function () {
        ...
        this.setNextStatement(true, null);
        this.setTooltip('');
        this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MP);
    }
};
...
Blockly.Blocks.actuator_neopixel_rgb_all = {
    init: function () {
        ...
        this.setNextStatement(true, null);
        this.setTooltip('');
        this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_ALL_R_G_B_MIXGOCC);
    }
};
...
Blockly.Blocks.actuator_use_uart_init = {
    init: function () {
        ...
        this.appendValueInput('SUB')
            ...
            .setCheck("var");
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_SETUP + Blockly.Msg.Lang.LISTS_SET_INDEX_INPUT_TO + 'SYN6288' + Blockly.Msg.Lang.MIXLY_AipSpeech_synthesis)
...
Blockly.Blocks.syn6288_set_voice = {
    init: function () {
        ...
        this.appendValueInput('VOICE')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_SET_VOLUME);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_SET_VOLUME_TOOLTIP);
    }
}
...
Blockly.Blocks.syn6288_get_voice = {
    init: function () {
        ...
        this.appendValueInput('SUB')
            .appendField('SYN6288')
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_GET_VOLUME)
        this.setOutput(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_SET_VOLUME_TOOLTIP);
    }
...
Blockly.Blocks.syn6288_builtin_voice = {
    init: function () {
        ...
        this.appendValueInput('VOICE')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PLAY_HINTS);
        this.appendDummyInput()
        .appendField(Blockly.Msg.Lang.MIXLY_PROGRAM_BLOCK)
        ...
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_PLAY_HINTS_TOOLTIP);
    }
}
...
Blockly.Blocks.syn6288_tts_play = {
    init: function () {
        ...
        this.appendValueInput('VOICE')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_BACKGROUND_MUSIC);
        this.appendDummyInput()
        .appendField(Blockly.Msg.Lang.MIXLY_PROGRAM_BLOCK)
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_TURTLE_WRITE_MOVE_TRUE, 'True'], [Blockly.Msg.Lang.MIXLY_TURTLE_WRITE_MOVE_FALSE, 'False']]), 'mode');      
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_PLAY_TTS_TOOLTIP);
    }
}