...
Blockly.Blocks.rm_actuator_led_bright = {
  init: function() {
    ...
    .appendField(Blockly.Msg.Lang.MIXLY_BUILDIN_LED)
        .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.COLOUR_RGB_RED, "r"],
                [Blockly.Msg.Lang.COLOUR_RGB_GREEN, "g"]
            ]), "color");
    this.appendValueInput('bright')
    .appendField(Blockly.Msg.Lang.MIXLY_PULSEIN_STAT)  
    this.setPreviousStatement(true, null);
    ...
    init: function () {
        ...
        switch (boardKey) {
            case 'micropython:esp32c3:mixgo_cc':
                this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MIXGOCC);
                break;
            case 'micropython:esp32s2:mixgo_ce':
                this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MIXGOCC);
                break;    
            case 'micropython:esp32c3:mixgo_me':
                this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MIXGOME);
                break;
            case 'micropython:esp32:mPython':
                this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MPYTHON);
                break;    
            default:
                this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_NUM_R_G_B_MIXGOME);
        }
...
Blockly.Blocks.actuator_onboard_neopixel_rgb_show_all_rainbow = {
    init: function () {
        ...
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_RGB);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_RAINBOW);
...
Blockly.Blocks.actuator_onboard_neopixel_rgb_show_all_chase = {
    init: function () {
        ...
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_RGB);
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_CHASE);
        this.appendValueInput("RVALUE")
            .setCheck(Number)
            .setAlign(Blockly.ALIGN_RIGHT)
            .appendField(Blockly.Msg.Lang.MIXLY_RGB_R);
...
Blockly.Blocks.actuator_dc_motor = {
    init: function () {
      ...
      this.appendDummyInput()
          .appendField(Blockly.Msg.Lang.MOTOR_DC)
          .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLYCAR_WHEEL_LEFT, "L"],
            [Blockly.Msg.Lang.MIXLYCAR_WHEEL_RIGHT, "R"]
            ]), "wheel");
      this.appendDummyInput()
          .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_Direction)
                  .appendField(new Blockly.FieldDropdown([
