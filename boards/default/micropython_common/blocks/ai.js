...
Blockly.Blocks.MICROPYTHON_AI_client = {
    init: function () {
        ...
        this.appendDummyInput("")
            ...
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_AipSpeech_asr, "ASR"],
                                                     [Blockly.Msg.Lang.MIXLY_AI_UNIT, "UNIT"]
                                                    ]),'CTYPE')
...
Blockly.Blocks.MICROPYTHON_AI_Speech_unit = { //  AI_TYPE_FUNC
    init: function () {
        this.setColour(Blockly.Msg['AI_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.Lang.MIXLY_AI_UNIT)
            .appendField(Blockly.Msg.Lang.MIXLY_Client)
            .setAlign(Blockly.ALIGN_RIGHT);
...
Blockly.Blocks.MICROPYTHON_AI_Speech_asr = { //  AI_TYPE_FUNC
    init: function () {
        ...
        this.appendDummyInput("")
            ...
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_AI_LANGUAGE_CHINESE, "1537"],
                                                     [Blockly.Msg.Lang.MIXLY_AI_LANGUAGE_ENGLISH, "1737"],
                                                     [Blockly.Msg.Lang.MIXLY_AI_LANGUAGE_CANTONESE, "1637"]
                                                    ]),'LANGUAGE')       
        this.setInputsInline(true);
        this.setOutput(true);
    }
