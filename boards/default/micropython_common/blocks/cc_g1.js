...
goog.provide('Blockly.Blocks.cc_g1');
goog.require('Blockly.Blocks');

Blockly.Msg['CCG1_HUE'] = 40

Blockly.Blocks['cc_g1_init'] = {
    init: function(){
        this.setColour(Blockly.Msg['CCG1_HUE']);        
...
Blockly.Blocks['cc_g1_read_joystick']={
    init: function () {
      	this.setColour(Blockly.Msg['CCG1_HUE']);
      	this.appendDummyInput()
