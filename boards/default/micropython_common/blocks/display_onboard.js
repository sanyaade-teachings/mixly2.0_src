...
Blockly.Blocks['bitbot_display_image_create']= {
  init: function() {
    this.appendDummyInput('')
        .appendField(Blockly.Msg.MIXLY_MICROBIT_JS_MONITOR_CREATE_IMAGE)    
    for (let i = 0; i < 12; i++) {
...
Blockly.Blocks.onboard_tft_show_image_xy = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
  this.appendValueInput('data')
        .appendField(Blockly.Msg.OLED_BITMAP);
...
Blockly.Blocks.onboard_tft_scroll_string = {
   init: function() {
     this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
     this.appendValueInput('data')
         .setCheck(String)
...
Blockly.Blocks.onboard_tft_scroll_string_delay = {
   init: function() {
     this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
     this.appendValueInput('data')
         .setCheck(String)
...
Blockly.Blocks.onboard_tft_show_frame_string = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
  this.appendValueInput('data')
        .setCheck(String)
...
Blockly.Blocks.onboard_tft_show_frame_string_delay = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
    this.appendValueInput('data')
        .setCheck(String)
...
Blockly.Blocks['onboard_tft_display_shape_rect'] = {
  init: function () {
    this.jsonInit({
      "colour": Blockly.Msg['DISPLAY_ONBOARD_HUE'],
      "args0": [        
...
Blockly.Blocks['onboard_tft_display_hvline'] = {
  init: function () {
    this.jsonInit({
      "colour": Blockly.Msg['DISPLAY_ONBOARD_HUE'],
      "args0": [        
...
Blockly.Blocks['onboard_tft_display_line'] = {
  init: function () {
    this.jsonInit({
      "colour": Blockly.Msg['DISPLAY_ONBOARD_HUE'],
      "args0": [        
...
Blockly.Blocks['onboard_tft_shift'] = {
  init: function() {
    var OPERATORS =
        [[Blockly.Msg.MIXLY_UP, 'shift_up'],
         [Blockly.Msg.MIXLY_DOWN, 'shift_down'],
...
Blockly.Blocks.onboard_tft_get_pixel = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
     this.appendDummyInput('')
...
Blockly.Blocks.onboard_tft_bright_point = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
    this.appendValueInput('x')
        .setCheck(Number)
...
Blockly.Blocks.onboard_tft_clear = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
  this.appendDummyInput()
        .appendField(Blockly.Msg.MIXLY_MICROBIT_Clear_display);
...
Blockly.Blocks.onboard_tft_get_screen_pixel = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
    this.appendDummyInput()
        .appendField(Blockly.Msg.MIXLY_ESP32_JS_MONITOR_GET_SCREEN_BRIGHTNESS);
...
Blockly.Blocks.onboard_tft_bright_screen = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
  this.appendValueInput('x')
      .setCheck(Number)
...
Blockly.Blocks.onboard_tft_fill = {
  init: function() {
    this.setColour(Blockly.Msg['DISPLAY_ONBOARD_HUE']);
  this.appendValueInput('VAR')
