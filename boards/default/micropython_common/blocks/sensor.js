...
Blockly.Blocks.sensor_mixgo_button_attachInterrupt = {
  init: function() {
    ...
    .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_RISING, "machine.Pin.IRQ_RISING"], [Blockly.Msg.Lang.MIXLY_FALLING, "machine.Pin.IRQ_FALLING"], [Blockly.Msg.Lang.MIXLY_CHANGE, "(machine.Pin.IRQ_RISING or machine.Pin.IRQ_FALLING)"]]), "mode");
...
Blockly.Blocks.sensor_dht11 = {
    init: function () {
        var WHAT = [[Blockly.Msg.Lang.MIXLY_GETTEMPERATUE, 'temperature'], [Blockly.Msg.Lang.MIXLY_GETHUMIDITY, 'relative_humidity'], [Blockly.Msg.Lang.MIXLY_DHT11_T_H, 'tempandhum']];
        this.setColour(Blockly.Msg['SENSOR_HUE']);
        this.appendValueInput("PIN", Number)
...
Blockly.Blocks.RTC_set_datetime = {
 init: function() {    
    ...
    this.appendValueInput('SUB')
    .appendField("RTC")
    .appendField(Blockly.Msg.Lang.MIXLY_RTC_TIME)
    .setCheck("var");
    this.appendValueInput('year')
    .setCheck(Number)
    .appendField("         "+Blockly.Msg.Lang.MIXLY_YEAR);
