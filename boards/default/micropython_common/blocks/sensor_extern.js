...
Blockly.Blocks['sensor_mixgo_extern_button_is_pressed'] = {
    init: function(){
        ...
        this.appendValueInput("STAT")
            .appendField(Blockly.Msg.Lang.MIXLY_ELECLEVEL);    
...
Blockly.Blocks['sensor_light_level'] = {
    init: function(){
        ...
        this.setOutput(true, Number);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_SENSOR_LIGHT_LEVEL_TOOLTIP);
    }
};
    ...
    init: function () {
        ...
        this.setTooltip(function () {
            ...
            var TOOLTIPS = {
                ...
                'relative_humidity': Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_GET_HUM,
                'tempandhum': Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_GET_TEM_HUM
            };
            return TOOLTIPS[op];
        });
    }
...
Blockly.Blocks['sensor_mixgo_extern_light'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_LIGHT);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PIN)
            .setCheck(Number);   
        this.appendDummyInput()
...
Blockly.Blocks['sensor_mixgo_extern_sound'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_SOUND);
        this.appendValueInput("PIN", Number)
            .appendField(Blockly.Msg.Lang.MIXLY_PIN)
            .setCheck(Number);
        this.appendDummyInput()
...
Blockly.Blocks['sensor_bmp'] = {
    init: function(){
        ...
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_GETTEMPERATUE, "get_BMP_temperature()"],
            [Blockly.Msg.Lang.MIXLY_GETPRESSURE, "get_BMP_pressure()"]
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
        var thisBlock = this;
        this.setTooltip(function() {
            var mode = thisBlock.getFieldValue('key');
            var TOOLTIPS = {
                "get_BMP_temperature()":Blockly.Msg.Lang.MIXLY_MICROBIT_SENSOR_BMP_temperature_TOOLTIP,
                "get_BMP_pressure()":Blockly.Msg.Lang.MIXLY_MICROBIT_SENSOR_BMP_press_TOOLTIP,
            };
...
Blockly.Blocks['sensor_sht'] = {
    init: function(){
        ...
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_GETTEMPERATUE, "get_SHT_temperature()"],
            [Blockly.Msg.Lang.MIXLY_GETHUMIDITY, "get_SHT_relative_humidity()"]
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
        var thisBlock = this;
        this.setTooltip(function() {
            var mode = thisBlock.getFieldValue('key');
            var TOOLTIPS = {
                "get_SHT_temperature()":Blockly.Msg.Lang.MIXLY_MICROBIT_SENSOR_SHT_temperature_TOOLTIP,
                "get_SHT_relative_humidity()":Blockly.Msg.Lang.MIXLY_MICROBIT_SENSOR_SHT_HUM_TOOLTIP,
            };
            return TOOLTIPS[mode]
        });
    }
...
Blockly.Blocks.sensor_ds18x20 = {
 init: function () {
    this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
    this.appendValueInput("PIN", Number)
    .appendField("DS18x20 "+Blockly.Msg.Lang.MIXLY_PIN)
    .setCheck(Number);
    this.appendDummyInput("")
    .appendField(Blockly.Msg.Lang.MIXLY_GETTEMPERATUE);
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_SENSOR_DS18X20_TOOLTIP);
}
};
...
Blockly.Blocks['sensor_MAX30102_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_MAX30102+" MAX30102");
        this.appendValueInput('SUB')
            //.appendField("BMP280")
            .setCheck("var");  
        this.appendDummyInput()
            ...
            .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_ESP32_MAX30102_IR, "[0]"],
            [Blockly.Msg.Lang.MIXLY_ESP32_MAX30102_RED, "[1]"],
            [Blockly.Msg.Lang.MIXLY_ESP32_MAX30102_IR+','+Blockly.Msg.Lang.MIXLY_ESP32_MAX30102_RED, ""],
            ]), "key")     
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['sensor_APDS9960_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_APDS9960+" APDS9960");
        this.appendValueInput('SUB')
            //.appendField("BMP280")
            .setCheck("var");  
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_GET)
            .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_ESP32_APDS9960_COLOR, "color"],
            [Blockly.Msg.Lang.MIXLY_ESP32_APDS9960_GESTURE, "gesture"],
            [Blockly.Msg.Lang.MIXLY_ESP32_APDS9960_APPROACH, "proximity"],
            ]), "key")     
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['sensor_LTR308_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_EXTERN_LIGHT+" LTR308");
        this.appendValueInput('SUB')
            //.appendField("BMP280")
            .setCheck("var");  
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_GET_LIGHT_INTENSITY);     
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
};
...
Blockly.Blocks['sensor_VL530LX_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_LASER_RANGE+" VL53L0X");
        this.appendValueInput('SUB')
            //.appendField("BMP280")
            .setCheck("var");  
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_GET_DISTANCE+'(mm)');     
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
};
...
Blockly.Blocks['sensor_shtc3_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.Lang.MIXLY_TEM_HUM+" SHTC3")
            .setCheck("var");
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_GETTEMPERATUE, "temperature"],
            [Blockly.Msg.Lang.MIXLY_GETHUMIDITY, "relative_humidity"]
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
        var thisBlock = this;
        this.setTooltip(function() {
            ...
            var TOOLTIPS = {
                ...
                "ALL":Blockly.Msg.Lang.MIXLY_TOOLTIP_BLOCKGROUP_GET_TEM_HUM
            };
            return TOOLTIPS[mode]
        });
    }
...
Blockly.Blocks['sensor_aht11_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.Lang.MIXLY_TEM_HUM+" AHT21")
            .setCheck("var");
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_GETTEMPERATUE, "temperature"],
...
Blockly.Blocks['sensor_QMC5883L_extern'] = {
    init: function(){
        ...
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_MICROBIT_JS_BY_ANGLE, "get_bearing()"],
            [Blockly.Msg.Lang.MIXLY_TEMPERATURE, "get_temp()"],            
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['extern_rfid_read'] = {
    init: function(){
        ...
        this.appendDummyInput("")
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.MIXLY_RFID_READ_CARD_UID, "id"],
                [Blockly.Msg.Lang.MIXLY_MICROBIT_PY_STORAGE_ALL, "content"],
                [Blockly.Msg.Lang.MIXLY_ALL, "ALL"]
                ]), "key");   
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['extern_rfid_status'] = {
    init: function(){
        ...
        this.appendDummyInput("")
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.MIXLY_RFID_SCAN_OK, "0"],
                [Blockly.Msg.Lang.MIXLY_RFID_SCAN_NOTAGERR, "1"],
                [Blockly.Msg.Lang.MIXLY_RFID_SCAN_ERROR, "2"]
                ]), "key");   
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['weather_set_label'] = {
  ...
  updateShape_: function() {
    ...
    if (this.itemCount_ == 0) {
      ...
      .appendField(Blockly.Msg.Lang.MIXLY_SETTING+Blockly.Msg.Lang.MIXLY_GPS_LOCATION+Blockly.Msg.Lang.mixpy_PYLAB_TICKS_TAG+'(id,long,lat)');
    } else {
      for (var i = 0; i < this.itemCount_; i++) {
        var input = this.appendValueInput('ADD' + i);
        if (i == 0) {
          input.appendField(Blockly.Msg.Lang.MIXLY_SETTING+Blockly.Msg.Lang.MIXLY_GPS_LOCATION+Blockly.Msg.Lang.mixpy_PYLAB_TICKS_TAG+'(id,long,lat)');
        }
      }
    }
  }
...
Blockly.Blocks['weather_set_label_container'] = {  
  init: function() {
    this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
    this.appendDummyInput()
    .appendField(Blockly.Msg.Lang.MIXLY_SETTING+Blockly.Msg.Lang.MIXLY_GPS_LOCATION+Blockly.Msg.Lang.mixpy_PYLAB_TICKS_TAG);
...
Blockly.Blocks['sensor_mixgoce_hot_wheel_is_touched'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_HOT_WHEEL)
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_TOUCH_SENSOR)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.MIXLY_UP, "4"],
                [Blockly.Msg.Lang.MIXLY_DOWN, "2"],
                [Blockly.Msg.Lang.MIXLY_LEFT, "3"],
                [Blockly.Msg.Lang.MIXLY_RIGHT, "1"],
                ["OK", "0"]
                ]), "key");
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_GET)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.MIXLY_DATA, "value"],
                [Blockly.Msg.Lang.MIXLY_PULSEIN_STAT, "is_touched()"]
                ]), "stat");
        this.setOutput(true, Boolean);
        this.setInputsInline(true);
        this.setTooltip();
...
Blockly.Blocks['sensor_mixgoce_hot_wheel_degrees'] = {
    init: function(){
        ...
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_HOT_WHEEL)
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_TOUCH_SENSOR)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_GET + Blockly.Msg.Lang.MIXLY_MICROBIT_JS_BY_ANGLE + '(-180°~180°)');
        this.setOutput(true, Boolean);
        this.setInputsInline(true);
        this.setTooltip();
    }
...
Blockly.Blocks['esp32_s2_weather_ws'] = {
    init: function(){
        ...
        this.appendDummyInput("")
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.blynk_IOT_IR_FAN, "0"],
                [Blockly.Msg.Lang.MIXLY_WIND_RATING, "1"],
                [Blockly.Msg.Lang.blynk_IOT_IR_FAN+Blockly.Msg.Lang.MIXLY_WIND_RATING, "ALL"]
                ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
    }
...
Blockly.Blocks.PS2_Button={
  init: function() {
   ...
   .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_BUTTON_HOLD ,"Button"]
    // ,[Blockly.Msg.Lang.MIXLY_BUTTON_PRESSED, "ButtonPressed"]
    // ,[Blockly.Msg.Lang.MIXLY_BUTTON_RELEASED,"ButtonReleased"]
    // ,[Blockly.Msg.Lang.MIXLY_CHANGE,"NewButtonState"]
    ]), "btstate");
   this.setOutput(true, Boolean);
   this.setTooltip('');
 }
...
Blockly.Blocks.PS2_State={
  init: function() {
   this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
   this.appendDummyInput("")
   .appendField(Blockly.Msg.Lang.MIXLY_GET+Blockly.Msg.Lang.PS2_BUTTON)
   .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_PULSEIN_STAT ,"0"]
    ,[Blockly.Msg.Lang.MIXLY_MICROBIT_JS_I2C_VALUE, "1"]
    // ,[Blockly.Msg.Lang.MIXLY_BUTTON_RELEASED,"ButtonReleased"]
    // ,[Blockly.Msg.Lang.MIXLY_CHANGE,"NewButtonState"]
    ]), "btstate");
   this.setOutput(true, Boolean);
...
Blockly.Blocks.PS2_stk={
  init: function() {
    this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
    var PSSTK =[
    [Blockly.Msg.Lang.PS2_RX,"0"],
    [Blockly.Msg.Lang.PS2_RY,"1"],
    [Blockly.Msg.Lang.PS2_LX,"2"],
    [Blockly.Msg.Lang.PS2_LY,"3"],
    ];
    this.appendDummyInput("")
...
Blockly.Blocks.PS2_Buttons_new={
  init: function() {
   ...
   .appendField(Blockly.Msg.Lang.PS2);
   this.appendDummyInput("")
   .appendField(Blockly.Msg.Lang.PS2_BUTTON.slice(3))
   .appendField(new Blockly.FieldDropdown(PSBUTTON), "psbt")
   .appendField(Blockly.Msg.Lang.MIXLY_WAS_PRESSED)
   this.setOutput(true, Boolean);
   this.setTooltip('');
...
Blockly.Blocks.PS2_stk_new={
  init: function() {
    this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
    var PSSTK =[
    [Blockly.Msg.Lang.PS2_RX,"RX"],
    [Blockly.Msg.Lang.PS2_RY,"RY"],
    [Blockly.Msg.Lang.PS2_LX,"LX"],
    [Blockly.Msg.Lang.PS2_LY,"LY"],
    ];
    this.appendValueInput('SUB')
   .appendField(Blockly.Msg.Lang.PS2);
    this.appendDummyInput("")
    .appendField(Blockly.Msg.Lang.MIXLY_JOYSTICK)
    .appendField(new Blockly.FieldDropdown(PSSTK), "psstk");
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
Blockly.Blocks.sensor_use_uart_init = {
    init: function () {
        ...
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_SETUP + Blockly.Msg.Lang.LISTS_SET_INDEX_INPUT_TO)
            .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.Lang.MIXLY_PM25_SENSOR, "PM"],         
                [Blockly.Msg.Lang.MIXLY_GNSS_SENSOR,"GNSS"]
                ]), "sensor");
...
Blockly.Blocks.pm25_get_data = {
    init: function () {
        ...
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_CONCENTRATION)    
        this.setOutput(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_PM_CONCENTRATION_TOOLTIP);
    }
}
...
Blockly.Blocks['gnss_have_data'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.Lang.MIXLY_GNSS_SENSOR)
            .setCheck("var");
        this.appendDummyInput("")
        .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_AVAILABLE)        
        this.setOutput(true, Number);
...
Blockly.Blocks['gnss_get_data'] = {
    init: function(){
        ...
        .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_GET)
        .appendField(new Blockly.FieldDropdown([
            [Blockly.Msg.Lang.MIXLY_GPS_TIME, "time"],
            [Blockly.Msg.Lang.MIXLY_GPS_LOCATION, "locate"],  
            [Blockly.Msg.Lang.MIXLY_PULSEIN_STAT, "status"]          
            ]), "key");
        this.setOutput(true, Number);
        this.setInputsInline(true);
        var thisBlock = this;
        this.setTooltip(function() {
            var mode = thisBlock.getFieldValue('key');
            var TOOLTIPS = {
                'time':Blockly.Msg.Lang.MIXLY_GNSS_SENSOR_GET_TIME_TOOLTIP,
                'locate':Blockly.Msg.Lang.MIXLY_GNSS_SENSOR_GET_LOCATE_TOOLTIP,
                'status':Blockly.Msg.Lang.MIXLY_GNSS_SENSOR_GET_STATUS_TOOLTIP
            };
            return TOOLTIPS[mode];
        });
    }
