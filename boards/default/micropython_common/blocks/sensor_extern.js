...
Blockly.Blocks['sensor_hp203_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.MIXLY_Altitude+MSG.catSensor+" HP203X")
            .setCheck("var");
        this.appendDummyInput("")
        .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks['sensor_QMC5883L_extern'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.MIXLY_MIXGOPE_FIELD+MSG.catSensor+" QMC5883L")
            .setCheck("var");
        this.appendDummyInput("")
...
Blockly.Blocks.esp32_s2_weather_init =  {
    init: function() {
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_SETUP+Blockly.Msg.ForecastType+MSG.catSensor);
...
Blockly.Blocks['esp32_s2_weather_wd'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.ForecastType+MSG.catSensor)
...
Blockly.Blocks.PS2_vibration={
  init: function() {
   ...
   .appendField(Blockly.Msg.MIXLY_STM32_OLED_SMALL+MSG.catActuator_motor)
   .appendField(new Blockly.FieldDropdown([
                [Blockly.Msg.MIXLY_MICROBIT_PY_COMMUNICATE_OFF, "0"],
                [Blockly.Msg.MIXLY_MICROBIT_PY_COMMUNICATE_ON, "1"],   
                ]), "smotorstate")            
   .appendField(Blockly.Msg.MIXLY_STM32_OLED_BIG+MSG.catActuator_motor+Blockly.Msg.MIXLY_MIXGOPE_AMPLITUDE)
   this.appendValueInput("AMP", Number)   
   this.setTooltip(Blockly.Msg.MIXLY_STM32_OLED_BIG+MSG.catActuator_motor+Blockly.Msg.MIXLY_MIXGOPE_AMPLITUDE+"0-100");
   this.setInputsInline(true);
   this.setPreviousStatement(true);
   this.setNextStatement(true);
 }
