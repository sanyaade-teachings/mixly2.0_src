...
Blockly.Blocks['sensor_LTR390UV_extern'] = {
    init:function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
...
Blockly.Blocks.sensor_weather_solo_init =  {
    init: function() {
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
...
Blockly.Blocks['sensor_weather_solo_wd'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
...
Blockly.Blocks['sensor_weather_solo_ws'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.weather_solo);
...
Blockly.Blocks['sensor_weather_solo_rain'] = {
    init: function(){
        this.setColour(Blockly.Msg['SENSOR_EXTERN_HUE']);
        this.appendValueInput('SUB')
            .appendField(Blockly.Msg.weather_solo);
