  ...
  init: function() {
   this.setColour(Blockly.Msg['SERIAL_HUE']);
    this.appendValueInput("CONTENT", String)
        ...
        .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_WRITE+'('+Blockly.Msg.Lang.LANG_MATH_BYTE+')');
...
Blockly.Blocks['serial_begin'] = {
  init: function() {
   this.setColour(Blockly.Msg['SERIAL_HUE']);
   this.appendDummyInput()
          .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_BEGIN)
          .appendField(new Blockly.FieldDropdown([['115200', '115200'], ['57600', '57600'], ['37400', '38400'], ['31250', '31250'], ['28800', '28800'], ['19200', '19200'], ['14400', '14400'], ['9600', '9600'], ['4800', '4800'], ['2400', '2400'], ['1200', '1200'], ['300', '300']]), 'baudrate');
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  this.setInputsInline(true);
  this.setTooltip(Blockly.Msg.Lang.LISTS_SET_INDEX_SET+Blockly.Msg.Lang.MIXLY_SERIAL_BEGIN);
  }
};
...
Blockly.Blocks['serial_send_to_ai'] = {
   init: function() {
    ...
    this.appendDummyInput()
        .appendField(Blockly.Msg.Lang.LANG_CONTROLS_FOR_INPUT_TO+Blockly.Msg.Lang.MIXLY_OTHER+'MP'+Blockly.Msg.Lang.MIXLY_DEVICE)
        .appendField(Blockly.Msg.Lang.LANG_CONTROLS_WHILEUNTIL_TITLE_REPEAT)
        .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_TURTLE_WRITE_MOVE_TRUE, 'True'], [Blockly.Msg.Lang.MIXLY_TURTLE_WRITE_MOVE_FALSE, 'False']]), 'STAT')
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
};
...
Blockly.Blocks['serial_read_from_ai'] = {
  init: function() {
    ...
    this.appendDummyInput()
        .appendField("Serial")
        .appendField(new Blockly.FieldDropdown([['uart1', '1'], ['uart2', '2']]), 'mode')
        .appendField(Blockly.Msg.Lang.MIXLY_ESP32_READ+Blockly.Msg.Lang.MIXLY_OTHER+'MP'+Blockly.Msg.Lang.MIXLY_DEVICE+Blockly.Msg.Lang.MIXLY_SD_DATA);
    this.setOutput(true, Boolean);
  }
};