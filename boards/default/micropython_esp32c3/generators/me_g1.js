...
Blockly.Python.me_g1_aht11=function(){
...
Blockly.Python.me_g1_hp203=function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_me_g1'] = 'import me_g1';
...
Blockly.Python.me_g1_varistor=function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_me_g1'] = 'import me_g1';
...
Blockly.Python.me_g1_rfid_readid=function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_me_g1'] = 'import me_g1';
...
Blockly.Python.me_g1_rfid_readcontent=function(){
...
Blockly.Python.me_g1_rfid_write=function(){
    var sector = Blockly.Python.valueToCode(this, 'SECTOR', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.me_g1_rfid_status=function(){
    var key = this.getFieldValue('key');
    Blockly.Python.definitions_['import_me_g1'] = 'import me_g1';
