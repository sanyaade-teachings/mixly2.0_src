...
Blockly.Blocks['communicate_i2c_scan'] = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck("var")
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_I2C_SCAN1);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_I2C_SCAN2);
        this.setOutput(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_I2C_SCAN);
    }
...
Blockly.Blocks['communicate_spi_set'] = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck('var')
            .appendField(Blockly.Msg.Lang.MIXLY_SETTING + " SPI")
        this.appendValueInput('data')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_SERIAL_BEGIN);
        this.setPreviousStatement(true, null);
...
Blockly.Blocks['communicate_spi_buffer'] = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck('var')
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_SET + 'SPI');
        this.appendValueInput('data')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_SPI_BUFFER);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setInputsInline(true);
...
Blockly.Blocks.communicate_i2c_available = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck("var")
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_READ + "I2C");
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_SUCCESS);
...
Blockly.Blocks['communicate_ow_init'] = {
    init: function() {
        ...
        this.appendValueInput('BUS')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_SETUP+' '+Blockly.Msg.Lang.MIXLY_PIN);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
...
Blockly.Blocks['communicate_ow_select'] = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck('var')
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_ONEWIRE_SELECT)
        this.appendValueInput('byte')
            .setCheck(String)
            .appendField("ROM");
        this.setPreviousStatement(true);
...
Blockly.Blocks['communicate_ow_reset'] = {
    init: function() {
        ...
        this.appendValueInput('VAR')
            .setCheck('var')
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_ONEWIRE_RESET);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
