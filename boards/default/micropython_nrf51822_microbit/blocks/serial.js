  ...
  init: function() {
   this.setColour(Blockly.Msg['SERIAL_HUE']);
    this.appendValueInput("CONTENT", String)
        .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_PRINT);
...
Blockly.Blocks['serial_println'] = {
   init: function() {
    this.setColour(Blockly.Msg['SERIAL_HUE']);
    this.appendValueInput("CONTENT", String)
        .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_PRINTLN);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['serial_print_hex'] = {
   init: function() {
    ...
    this.appendValueInput("CONTENT", Number)
        .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_PRINT + "  (" + Blockly.Msg.Lang.MATH_HEX + ")")
        .setCheck(Number);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
...
Blockly.Blocks['serial_readstr'] = {
  init: function() {
	...
	this.appendDummyInput()
        .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_READSTR);
...
Blockly.Blocks['serial_any'] = {
  init: function() {
    this.setColour(Blockly.Msg['SERIAL_HUE']);
  this.appendDummyInput()
        .appendField("Serial " + Blockly.Msg.Lang.MIXLY_SERIAL_AVAILABLE);
...
Blockly.Blocks['serial_readline'] = {
    init: function() {
        this.setColour(Blockly.Msg['SERIAL_HUE']);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_SERIAL_READ_LINE);
        this.setOutput(true, String);
