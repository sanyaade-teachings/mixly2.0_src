...
Blockly.Python.forBlock['game_create_sprite'] = function(){
...
Blockly.Python.forBlock['game_move_by'] = function(){
...
Blockly.Python.forBlock['game_delete_var'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['var_declare' + item] =  'let ' + item  + ':game.LedSprite = null;';
...
Blockly.Python.forBlock['game_turn_by_direction'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['game_change_by'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['game_set_xy'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
    var change_key = this.getFieldValue('change_key');
    var data = Blockly.Python.valueToCode(this, 'data', Blockly.Python.ORDER_ATOMIC);
    Blockly.Python.definitions_['var_declare' + item] =  'let ' + item  + ':game.LedSprite = null;';
...
Blockly.Python.forBlock['game_get_xy'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
    var change_key = this.getFieldValue('change_key');
...
Blockly.Python.forBlock['game_touch_another'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['game_touch_edge'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['game_on_edge_and_bounce'] = function(){
    var item = Blockly.Python.valueToCode(this, 'var', Blockly.Python.ORDER_ATOMIC);
...
Blockly.Python.forBlock['game_change_score'] = function(){
    var data = Blockly.Python.valueToCode(this, 'data', Blockly.Python.ORDER_ATOMIC);
    var code = 'game.addScore('  + data +  ');\n';
    return code;
};

Blockly.Python.forBlock['game_set_score'] = function(){
    var data = Blockly.Python.valueToCode(this, 'data', Blockly.Python.ORDER_ATOMIC);
    var code = 'game.setScore('  + data +  ');\n';
    return code;
};

Blockly.Python.forBlock['game_start_countdown'] = function(){
    var data = Blockly.Python.valueToCode(this, 'data', Blockly.Python.ORDER_ATOMIC);
    var code = 'game.startCountdown(' + data + ');\n';
    return code;
};

Blockly.Python.forBlock['game_get_score'] = function() {
    return ["game.score()", Blockly.Python.ORDER_ATOMIC];
}

Blockly.Python.forBlock['game_over'] = function() {
    return "game.gameOver();\n";
}

Blockly.Python.forBlock['game_resume'] = function() {
    return "game.resume();\n";
}
