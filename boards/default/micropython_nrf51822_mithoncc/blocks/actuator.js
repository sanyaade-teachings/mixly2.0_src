...
Blockly.Msg['ACTUATOR_HUE'] = 100//'#b574c2';
...
Blockly.Blocks['microbit_music_play_built_in'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Play_built_in_melody,
      "args0" : [{
          "name" : "melody",
    ...
    this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Play_built_in_melody1);
  }
};
...
Blockly.Blocks['microbit_music_play_built_in_easy'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Play_built_in_melody_easy,
      "args0" : [{
          "name" : "melody",
          "options" : [["DADADADUM", "DADADADUM"], ["ENTERTAINER", "ENTERTAINER"], ["PRELUDE", "PRELUDE"], ["ODE", "ODE"], ["NYAN", "NYAN"], ["RINGTONE", "RINGTONE"], ["FUNK", "FUNK"], ["BLUES", "BLUES"], ["BIRTHDAY", "BIRTHDAY"], ["WEDDING", "WEDDING"], ["FUNERAL", "FUNERAL"], ["PUNCHLINE", "PUNCHLINE"], ["PYTHON", "PYTHON"], ["BADDY", "BADDY"], ["CHASE", "CHASE"], ["BA_DING", "BA_DING"], ["WAWAWAWAA", "WAWAWAWAA"], ["JUMP_UP", "JUMP_UP"], ["JUMP_DOWN", "JUMP_DOWN"], ["POWER_UP", "POWER_UP"], ["POWER_DOWN", "POWER_DOWN"]],
          "type" : "field_dropdown"
...
init:function(){
    ...
    this.appendDummyInput("")
        ...
        .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_WAIT);
    this.appendDummyInput("")
...
Blockly.Blocks['microbit_music_play_list_of_notes'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Play_notes,
      "args0" : [{
          "check" : "List",
          "type" : "input_value",
          "name" : "notes"
    ...
    this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Play_notes1);
  }
};
...
Blockly.Blocks['microbit_music_reset'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Reset_music
    });
    this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Reset_music);
  }
};
...
init:function(){
    ...
    this.setPreviousStatement(true);
    this.setNextStatement(true);
    this.setTooltip(Blockly.Msg.Lang.MIXLY_NOTONE);
  }
};
...
Blockly.Blocks['microbit_music_get_tempo'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Get_current_tempo
    });
    this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Get_current_tempo);
  }
};
...
Blockly.Blocks.tone_set_tempo = {
    init: function () {
        ...
        this.appendValueInput('TICKS')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_SET_TEMPO)
        ...
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_SET_TEMPO1);
    }
}
...
Blockly.Blocks['speech_say'] = {
    init: function () {
        ...
        this.appendValueInput('VAR')
            .setCheck(String)
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SAY,'say'],[Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SING,'sing'],[Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_PRENOUNCE,
              'pronounce']]),"MODE");
        this.appendValueInput('pitch')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_pitch);
        this.appendValueInput('speed')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_SPEED);
        this.appendValueInput('mouth')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_mouth);
        this.appendValueInput('throat')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_throat);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        var thisBlock = this;
        ...
        var mode0 = Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH;
        var mode1 = Blockly.Msg.Lang.MIXLY_MICROBIT_TYPE_STRING
        var TOOLTIPS = {
        'say':Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SAY,
        'sing':Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SING,
        'pronounce':Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_PRENOUNCE
      };
...
//         this.appendValueInput('VAR')
//           .setCheck(String)
//           .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SING);
//         this.appendValueInput('pitch')
//             .setCheck(Number)
//             .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_pitch);
//         this.appendValueInput('speed')
...
//         this.appendValueInput('VAR')
//           .setCheck(String)
//           .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_PRENOUNCE);
//         this.appendValueInput('pitch')
//             .setCheck(Number)
//             .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_pitch);
//         this.appendValueInput('speed')
...
Blockly.Blocks['speech_say_easy'] = {
    init: function () {
        ...
        this.appendValueInput('VAR')
            .setCheck(String)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_PY_ACTUATOR_SPEECH_SAY);
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
    }
...
Blockly.Blocks['speech_translate'] = {
    init: function () {
        ...
        this.appendValueInput('VAR')
          .setCheck(String)
          .appendField(Blockly.Msg.Lang.MICROBIT_SPEECH_translation);
        this.setOutput(true, String);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROPYTHON_SOCKET_MAKE+Blockly.Msg.Lang.MIXLY_MICROBIT_TYPE_STRING+Blockly.Msg.Lang.MICROBIT_SPEECH_translation);
    }
};
...
Blockly.Blocks.display_rgb_init = {
    init: function () {
        ...
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_RGB_PIN_COUNT);
    }
};
...
Blockly.Blocks.display_rgb_show = {
    init: function () {
        ...
        this.appendDummyInput("")
            .appendField(Blockly.Msg.Lang.MIXLY_RGB)
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_ESP32_RGB_WRITE)
        this.setInputsInline(true);
        this.setPreviousStatement(true, null);
        this.setNextStatement(true, null);
        this.setTooltip('');
        this.setTooltip(Blockly.Msg.Lang.MIXLY_ESP32_MUSIC_WRI);
    }
};
...
Blockly.Blocks.MP3_INIT = {
  init: function () {
    this.setColour(Blockly.Msg['ACTUATOR_HUE']);
    this.appendDummyInput("")
    .appendField(Blockly.Msg.Lang.MIXLY_SETUP + ' ' + Blockly.Msg.Lang.QJ00X_MP3);
...
[Blockly.Msg.Lang.MIXLY_MP3_NEXT, "next_track"],
[Blockly.Msg.Lang.MIXLY_MP3_PREV, "prev_track"],
[Blockly.Msg.Lang.MIXLY_MP3_VOL_UP, "inc_vol"],
[Blockly.Msg.Lang.MIXLY_MP3_VOL_DOWN, "dec_vol"]
];
...
Blockly.Blocks.MP3_CONTROL = {
  init: function () {
    this.setColour(Blockly.Msg['ACTUATOR_HUE']);
    this.appendDummyInput("")
    .appendField(Blockly.Msg.Lang.QJ00X_MP3);
    this.appendDummyInput("")
...
//MP3循环模式
var MP3_LOOP_MODE = [
[Blockly.Msg.Lang.MIXLY_MP3_LOOP_ALL, "0"],
[Blockly.Msg.Lang.MIXLY_MP3_LOOP_FOLDER, "1"],
[Blockly.Msg.Lang.MIXLY_MP3_LOOP_ONE, "2"],
[Blockly.Msg.Lang.MIXLY_MP3_LOOP_RAM, "3"]
];
...
//MP3 设置EQ
var MP3_EQ_MODE = [
[Blockly.Msg.Lang.MIXLY_MP3_EQ_NORMAL, "0"],
[Blockly.Msg.Lang.MIXLY_MP3_EQ_POP, "1"],
[Blockly.Msg.Lang.MIXLY_MP3_EQ_ROCK, "2"],
[Blockly.Msg.Lang.MIXLY_MP3_EQ_JAZZ, "3"],
[Blockly.Msg.Lang.MIXLY_MP3_EQ_CLASSIC, "4"],
[Blockly.Msg.Lang.MIXLY_MP3_EQ_BASS, "5"]
];
...
Blockly.Blocks.MP3_PLAY_FOLDER = {
  init: function () {
    ...
    .appendField(Blockly.Msg.Lang.DFPLAYER_MINI_FOLDER)
    .setCheck(Number);
    this.appendValueInput("NUM", Number)
    .appendField(Blockly.Msg.Lang.MIXLY_MP3_PLAY_NUM)
    .setCheck(Number);
