...
Blockly.Blocks['radio_ons'] = {
    init: function() {
        ...
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([[Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_ON,'on'],[Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_OFF,'off'],[Blockly.Msg.Lang.HTML_RESET,'reset']]), "type")
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_WIFI);
        ...
        var mode0 =Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_WIFI;
        var TOOLTIPS = {
        'on':Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_ON,
        'off':Blockly.Msg.Lang.MIXLY_MICROBIT_PY_COMMUNICATE_OFF,
        'reset':Blockly.Blockly.Msg.Lang.HTML_RESET
      };
...
Blockly.Blocks['microbit_radio_on'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Switch_on_radio
    });
  }
};
...
Blockly.Blocks['microbit_radio_off'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Switch_off_radio
    });
  }
};
...
Blockly.Blocks['microbit_radio_config'] = {
  init : function () {
    this.jsonInit({
      ...
      "tooltip" : Blockly.Msg.Lang.MIXLY_MICROBIT_Configure_radio1,
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Configure_radio,
      "args0" : [{
          "min" : 4,
          "value" : 32,
          "type" : "input_value",
...
Blockly.Blocks['microbit_radio_reset'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Reset_radio
    });
  }
};
...
Blockly.Blocks['microbit_radio_send_string'] = {
  init : function () {
    this.jsonInit({
      ...
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Send_message,
      "args0" : [{
          "check" : "String",
          "type" : "input_value",
          "name" : "message"
...
Blockly.Blocks['radio_send_string'] = {
    init:function(){
        this.setColour(225);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_RADIO_SEND);
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([
              [Blockly.Msg.Lang.MIXLY_MICROBIT_MSG,'send'],
              [Blockly.Msg.Lang.MIXLY_MICROBIT_MSG_BYTE,'send_bytes']]), "type")
        this.appendValueInput('data')
            // .setCheck(String)
        this.setPreviousStatement(true);
        this.setNextStatement(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Send_message1);
    }
}
...
Blockly.Blocks['microbit_radio_receive'] = {
  init : function () {
    this.jsonInit({
      ...
      "tooltip" :  Blockly.Msg.Lang.MIXLY_MICROBIT_Receive_message,
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_Receive_message
    });
  }
};
...
Blockly.Blocks['radio_receive_string'] = {
    init:function(){
        this.setColour(225);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_Receive_message);
        this.appendDummyInput()
            .appendField(new Blockly.FieldDropdown([
              [Blockly.Msg.Lang.MIXLY_MICROBIT_MSG,'receive'],
              [Blockly.Msg.Lang.MIXLY_MICROBIT_MSG_BYTE,'receive_bytes'],
              [Blockly.Msg.Lang.MIXLY_MICROBIT_MSG_FULL,'receive_full']]), "type")
        this.setOutput(true);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_Receive_message);
    }
}
...
Blockly.Blocks['i2c_init'] = {
  init: function() {
   ...
   this.appendValueInput("RX", Number)
       ...
       .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_I2C_SETUP)
       .appendField("sda")
       .setCheck(Number)
...
Blockly.Blocks['i2c_read'] = {
    init:function(){
        ...
        this.appendValueInput('address')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_I2C_READ_ADDRESS);
        this.appendValueInput('data')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.LANG_MATH_BYTE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.Lang.CONTROLS_REPEAT_TITLE_REPEAT)
...
Blockly.Blocks['i2c_write'] = {
    init:function(){
        ...
        this.appendValueInput('address')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_I2C_WRITE_ADDRESS);
        this.appendValueInput('data')
            .setCheck(Number)
...
Blockly.Blocks['spi_init'] = {
  init : function () {
    this.jsonInit({
      ...
      "nextStatement" : null,
      "previousStatement" : null,
      "message0" : Blockly.Msg.Lang.MIXLY_MICROBIT_SPI_INIT,
      "args0" : [{
          "value" : 1000000,
          "type" : "field_number",
          "name" : "freq"
...
Blockly.Blocks['spi_write'] = {
    init: function () {
        ...
        this.appendValueInput('data')
            .setCheck(Number)
            .appendField(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_SPI_WRITE);

        this.setOutput(true, Number);
        this.setInputsInline(true);
        this.setTooltip(Blockly.Msg.Lang.MIXLY_MICROBIT_JS_SPI_WRITE);
    }
}
