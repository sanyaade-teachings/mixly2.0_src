...
Blockly.Blocks['algorithm_prepare_2_1'] = {
  init: function() {
    this.setColour(Blockly.Msg['ALGORITHM_HUE']);
    this.appendDummyInput()
...
Blockly.Blocks['algorithm_prepare_2_2'] = {
  init: function() {
    this.setColour(Blockly.Msg['ALGORITHM_HUE']);
    this.appendDummyInput()
...
Blockly.Blocks['algorithm_not_school']={
  init: function() {
    this.setColour(Blockly.Msg['ALGORITHM_HUE']);
    this.appendDummyInput()
...
Blockly.Blocks.algorithm_init_jttl = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_rabbit_zero = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_rabbit_number_in_range = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_chick_calculate = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_check_feet = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_print_jttl_answer = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_rabbit_add = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_init_fzsf = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("加载路线图");
...
Blockly.Blocks.algorithm_fz_calc = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("计算")
...
Blockly.Blocks.algorithm_fz_calc_first_min = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_fz_compare = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField(new Blockly.FieldDropdown([
...
Blockly.Blocks.algorithm_fz_set_min = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("设置")
...
Blockly.Blocks.algorithm_fz_move = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_init_hxdb = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
...
Blockly.Blocks.algorithm_hxdb_init_soldier = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("初始化士兵为")
...
Blockly.Blocks.algorithm_hxdb_stand_in_line = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("使士兵")
...
Blockly.Blocks.algorithm_hxdb_last_line = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("剩余")
...
Blockly.Blocks.algorithm_hxdb_add = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("增加1个士兵");
...
Blockly.Blocks.algorithm_hxdb_result = {
    init: function () {
        this.appendDummyInput()
            .setAlign(Blockly.ALIGN_LEFT)
            .appendField("输出士兵数量");
