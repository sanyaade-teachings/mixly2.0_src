...
export const onboard_oled_scroll_string = {
    init: function () {
        this.setColour(DISPLAY_ONBOARD_HUE);
        this.appendValueInput('data')
            .setCheck(String)
...
export const onboard_oled_show_frame_string = {
    init: function () {
        this.setColour(DISPLAY_ONBOARD_HUE);
        this.appendValueInput('data')
            .setCheck(String)
...
export const onboard_oled_shift = {
    init: function () {
        var OPERATORS = [
            [Blockly.Msg.MIXLY_UP, 'shift_up'],
            [Blockly.Msg.MIXLY_DOWN, 'shift_down'],
...
export const onboard_oled_get_pixel = {
    init: function () {
        this.setColour(DISPLAY_ONBOARD_HUE);
        this.appendValueInput('x')
            .setCheck(Number)
...
export const onboard_oled_clear = {
    init: function () {
        this.setColour(DISPLAY_ONBOARD_HUE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_MICROBIT_Clear_display);
...
export const onboard_tft_show_string = {
    init: function () {
        this.setColour(DISPLAY_ONBOARD_HUE);
        this.appendValueInput('data')
            .setCheck([String, "esp32_image", "List", 'Tuple'])
