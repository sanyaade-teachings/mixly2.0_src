...
export const sensor_mixgo_pin_near_triple = {
    init: function () {
        this.setColour(SENSOR_ONBOARD_HUE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_MICROBIT_PY_STORAGE_GET)
...
export const sensor_mpython_qmi8658_get_acceleration = {
    init: function () {
        this.setColour(SENSOR_ONBOARD_HUE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_MICROBIT_JS_ACCELERATION)
...
export const sensor_mpython_mmc5603_get_magnetic = {
    init: function () {
        this.setColour(SENSOR_ONBOARD_HUE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_MICROBIT_JS_GET + Blockly.Msg.MIXLY_MICROBIT_JS_FIELD_STRENGTH)
...
export const sensor_mpython_mmc5603_get_angle = {
    init: function () {
        this.setColour(SENSOR_ONBOARD_HUE);
        this.appendDummyInput()
            .appendField(Blockly.Msg.MIXLY_MICROBIT_JS_GET_COMPASS + Blockly.Msg.MIXLY_MICROBIT_JS_BY_ANGLE)
...
export const sensor_bitbot_LTR308 = {
    init: function () {
        this.setColour(SENSOR_ONBOARD_HUE);
        this.appendDummyInput()
