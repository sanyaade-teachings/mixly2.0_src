...
export const mixgo_cc_actuator_led_bright = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
...
export const mixgo_cc_actuator_get_led_bright = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version] = 'import ' + version;
...
export const mixgo_cc_actuator_get_led_state = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version] = 'import ' + version;
...
export const mixgo_cc_actuator_led_brightness = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version] = 'import ' + version;
    var flag = generator.valueToCode(this, 'bright', generator.ORDER_ATOMIC);
...
export const mixgo_actuator_led_bright = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version + '_onboard_led' + op] = 'from ' + version + ' import led' + op;
    var bright = generator.valueToCode(this, 'bright', generator.ORDER_ATOMIC);
    var code = "led" + op + ".setonoff(" + bright + ")\n";
    return code;
}

export const mixgo_actuator_get_led_bright = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version + '_onboard_led' + op] = 'from ' + version + ' import led' + op;
...
export const mixgo_actuator_get_led_state = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version + '_onboard_led' + op] = 'from ' + version + ' import led' + op;
...
export const mixgo_actuator_led_brightness = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    var op = generator.valueToCode(this, 'led', generator.ORDER_ATOMIC);
    generator.definitions_['import_' + version + '_onboard_led' + op] = 'from ' + version + ' import led' + op;
    var flag = generator.valueToCode(this, 'bright', generator.ORDER_ATOMIC);
...
export const actuator_mixgo_nova_music_play_list = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (version == 'mixgo_zero') {
...
export const actuator_mixgo_nova_onboard_music_pitch = function (_, generator) {
    generator.definitions_['import_mixgo_nova_voice_spk_midi'] = "from mixgo_nova_voice import spk_midi";
    var number_pitch = generator.valueToCode(this, 'pitch', generator.ORDER_ATOMIC);
...
export const actuator_mixgo_nova_onboard_music_pitch_with_time = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (version == 'mixgo_zero') {
        generator.definitions_['import_mixgo_zero_voice_spk_midi'] = "from mixgo_zero_voice import spk_midi";
    } else {
...
export const actuator_mixgo_nova_onboard_music_stop = function (_, generator) {
    generator.definitions_['import_mixgo_nova_voice_spk_midi'] = "from mixgo_nova_voice import spk_midi";
