...
export const communicate_i2c_onboard = function (_, generator) {
...
export const communicate_spi_onboard = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
...
export const communicate_ir_recv_init = function (_, generator) {
...
export const internal_variable = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
...
export const recv_fun = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
...
export const ir_whether_recv = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
    var code = "ir_rx.any()";
    return [code, generator.ORDER_ATOMIC];
}

export const ir_recv_timeout = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
...
export const communicate_ir_send_init = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
    var pin = generator.valueToCode(this, 'PIN', generator.ORDER_ATOMIC);
...
export const ir_transmit_conventional_data = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
...
export const ir_transmit_study_code = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
...
export const ir_transmit_busy = function (_, generator) {
    generator.definitions_['import_irremote'] = 'import irremote';
    var code = "ir_tx.busy()";
    return [code, generator.ORDER_ATOMIC];
}

export const communicate_bluetooth_central_init = function (_, generator) {
...
export const communicate_bluetooth_peripheral_init = function (_, generator) {
...
export const communicate_bluetooth_scan = function (_, generator) {
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var code = name + ".scan()";
    return [code, generator.ORDER_ATOMIC];
}

export const communicate_bluetooth_connect = function (_, generator) {
    var data = generator.valueToCode(this, 'data', generator.ORDER_ATOMIC);
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
...
export const communicate_bluetooth_disconnect = function (_, generator) {
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var code = name + '.disconnect()\n';
    return code;
}

export const communicate_bluetooth_mac = function (_, generator) {
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    return [name + ".mac", generator.ORDER_ATOMIC];
}

export const communicate_bluetooth_is_connected = function (_, generator) {
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var code = name + ".is_connected()";
    return [code, generator.ORDER_ATOMIC];
}

export const communicate_bluetooth_send = function (_, generator) {
    var data = generator.valueToCode(this, 'data', generator.ORDER_ATOMIC);
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
...
export const communicate_bluetooth_recv_only = function (_, generator) {
    var v = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var code = v + '.recv()';
    return [code, generator.ORDER_ATOMIC];
}

export const communicate_bluetooth_recv = function (_, generator) {
    var v = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
...
export const communicate_bluetooth_handle = function (_, generator) {
...
//espnow
export const communicate_espnow_init = function (_, generator) {
...
export const communicate_espnow_init_new = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var varName = generator.valueToCode(this, 'CHNL', generator.ORDER_ATOMIC);
...
export const network_espnow_mac = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    return [name + ".mac", generator.ORDER_ATOMIC];
}

export const network_espnow_info = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    return [name + ".info()", generator.ORDER_ATOMIC];
}

export const network_espnow_recv = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var mode = this.getFieldValue('mode');
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
...
export const network_espnow_send = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
...
export const network_espnow_recv_handle = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var method = generator.valueToCode(this, 'METHOD', generator.ORDER_ATOMIC);
...
//radio
export const espnow_radio_channel = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
    var varName = generator.valueToCode(this, 'CHNL', generator.ORDER_ATOMIC);
    var code = "ESPNow_radio.set_channel(" + varName + ")\n";
    return code;
}

export const espnow_radio_channel_new = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    var varName2 = generator.valueToCode(this, 'DB', generator.ORDER_ATOMIC);
...
export const espnow_radio_on_off = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
...
export const espnow_radio_send = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
...
export const espnow_radio_rec = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
...
export const espnow_radio_recv_msg = function (_, generator) {
    var code = "ESPNow_radio_msg";
    return [code, generator.ORDER_ATOMIC];
}

export const espnow_radio_recv = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['import_ubinascii'] = 'import ubinascii';
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
    var doCode = generator.statementToCode(this, 'DO') || generator.PASS;
...
export const espnow_radio_recv_certain_msg = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['import_ubinascii'] = 'import ubinascii';
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
    var doCode = generator.statementToCode(this, 'DO') || generator.PASS;
    generator.definitions_['def_ESPNow_radio_recv_all'] = '_radio_msg_list = []\n' + 'def ESPNow_radio_recv_callback(mac,ESPNow_radio_msg):\n' + '    global _radio_msg_list\n' + '    try: ESPNow_radio_recv(mac,ESPNow_radio_msg)\n' + '    except: pass\n' + '    if str(ESPNow_radio_msg) in _radio_msg_list:\n' + "        eval('radio_recv_' + bytes.decode(ubinascii.hexlify(ESPNow_radio_msg)) + '()')\n";
    generator.definitions_['ESPNow_radio_recv_callback'] = "ESPNow_radio.recv_cb(ESPNow_radio_recv_callback)\n";
    var message = this.getFieldValue('msg');
...
export const espnow_radio_recv_new = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
...
export const espnow_radio_recv_certain_msg_new = function (_, generator) {
    generator.definitions_['import_radio'] = "import radio";
    generator.definitions_['ESPNow_radio_initialize'] = "ESPNow_radio=radio.ESPNow(channel=1)";
    generator.definitions_['ESPNow_radio_handlelist'] = "handle_list=[]";
    var doCode = generator.statementToCode(this, 'DO') || generator.PASS;
...
export const lora_init = function (_, generator) {
...
export const lora_packet = function (_, generator) {
    generator.definitions_['import_rfm98'] = 'import rfm98';
...
export const lora_send = function (_, generator) {
    generator.definitions_['import_rfm98'] = 'import rfm98';
    var data = generator.valueToCode(this, 'data', generator.ORDER_ATOMIC);
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    var code = name + ".send(" + data + ")\n";
...
export const lora_recv = function (_, generator) {
    generator.definitions_['import_rfm98'] = 'import rfm98';
    var name = generator.valueToCode(this, 'VAR', generator.ORDER_ATOMIC);
    return [name + '.recv()', generator.ORDER_ATOMIC];
}

export const urequests_get = function (_, generator) {
...
export const urequests_attribute = function (_, generator) {
    generator.definitions_.import_requests = "import urequests";
...
export const urequests_method = function (_, generator) {
    generator.definitions_.import_requests = "import urequests";
