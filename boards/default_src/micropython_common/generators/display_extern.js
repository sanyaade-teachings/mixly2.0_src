...
export const display_matrix_extern_clear = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var code = v + '.fill(0)\n' + v + '.show()\n';
    return code;
}

export const display_matrix_extern_shift = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
...
export const display_matrix_extern_get_pixel = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
...
export const display_matrix_extern_image_builtins = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
...
export const matrix_extern_image_arithmetic = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var op = this.getFieldValue("OP");
...
export const matrix_extern_image_invert = function (_, generator) {
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var imga = generator.valueToCode(this, 'A', generator.ORDER_ATOMIC);
...
export const image_shift = function (_, generator) {
    generator.definitions_['import_matrix'] = 'import matrix';
    var op = this.getFieldValue("OP");
    var image = generator.valueToCode(this, 'img', generator.ORDER_ATOMIC);
    var value = generator.valueToCode(this, 'val', generator.ORDER_ATOMIC);
...
export const extern_oled_clear = function (_, generator) {
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var code = v + '.fill(0)\n' + v + '.show()\n';
    return code;
...
export const extern_oled_shift = function (_, generator) {
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var op = this.getFieldValue("OP");
    var value = generator.valueToCode(this, 'val', generator.ORDER_ATOMIC);
...
export const extern_oled_get_pixel = function (_, generator) {
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var value_x = generator.valueToCode(this, 'x', generator.ORDER_ATOMIC);
    var value_y = generator.valueToCode(this, 'y', generator.ORDER_ATOMIC);
...
export const extern_oled_shape_rect = function (_, generator) {
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
...
export const extern_oled_hvline = function (_, generator) { //水平线
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
    var x = generator.valueToCode(this, 'x', generator.ORDER_ATOMIC);
    var y = generator.valueToCode(this, 'y', generator.ORDER_ATOMIC);
...
export const extern_oled_line = function (_, generator) {
    generator.definitions_['import_oled128x64'] = 'import oled128x64';
    var v = generator.valueToCode(this, 'SUB', generator.ORDER_ATOMIC);
