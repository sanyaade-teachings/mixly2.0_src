...
export const sensor_mixgo_sound = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (version == "mixgo") {
        generator.definitions_['import_mixgo'] = 'import mixgo';
...
export const sensor_get_temperature = function (_, generator) {
    generator.definitions_['import_feiyi_onboard_acc'] = 'from feiyi import _onboard_acc';
...
export const onboard_RTC_set_datetime = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + 'rtc_clock'] = 'from ' + version + ' import rtc_clock';
...
export const sensor_mixgo_cc_mmc5603_get_magnetic = function (_, generator) {
    ...
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    if (key == 'all') {
        generator.definitions_['import_' + version + '_onboard_mmc5603'] = "from " + version + " import onboard_mmc5603";
...
export const sensor_mpython_qmi8658_get_acceleration = function (_, generator) {
    var key = this.getFieldValue('key');
...
export const sensor_mpython_mmc5603_get_magnetic = function (_, generator) {
    var key = this.getFieldValue('key');
...
export const sensor_mpython_mmc5603_get_angle = function (_, generator) {
    generator.definitions_['import_mpython_magnetic'] = 'from mpython import magnetic';
...
export const sensor_bitbot_LTR308 = function (_, generator) {
    var version = Mixly.Boards.getSelectedBoardKey().split(':')[2]
    generator.definitions_['import_' + version + '_onboard_als'] = "from " + version + " import onboard_als";
    var code = 'onboard_als.als_vis()';
    return [code, generator.ORDER_ATOMIC];
