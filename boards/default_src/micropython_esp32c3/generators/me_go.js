...
export const me_go_light_number = function () {
    Python.definitions_['import_me_go_car'] = 'from me_go import car';
    var code = 'car.' + this.getFieldValue('op');
    return [code, Python.ORDER_ATOMIC];
};

export const me_go_led_bright = function () {
...
export const me_go_get_led_bright = function () {
    var op = Python.valueToCode(this, 'led', Python.ORDER_ATOMIC);
    Python.definitions_['import_me_go_car'] = 'from me_go import car';
...
export const me_go_get_led_state = function () {
    var op = Python.valueToCode(this, 'led', Python.ORDER_ATOMIC);
    Python.definitions_['import_me_go_car'] = 'from me_go import car';
...
export const me_go_led_brightness = function () {
    var op = Python.valueToCode(this, 'led', Python.ORDER_ATOMIC);
    Python.definitions_['import_me_go_car'] = 'from me_go import car';
...
export const me_go_stepper_keep = function () {
...
export const me_go_stepper_stop = function () {
    var v = this.getFieldValue('VAR');
    Python.definitions_['import_me_go_car'] = 'from me_go import car';
    var code = 'car.move("' + v + '")\n';
    return code;
...
export const me_go_dc_motor = function () {
...
export const me_go_hall_attachInterrupt = function () {
    var dropdown_mode = this.getFieldValue('mode');
    Python.definitions_['import_me_go_hall_' + dropdown_mode] = 'from me_go import hall_' + dropdown_mode;
...
export const me_go_hall_initialize = function () {
    var dropdown_mode = this.getFieldValue('mode');
...
export const me_go_hall_data = function () {
    var dropdown_mode = this.getFieldValue('mode');
    var args = this.getFieldValue('args');
    Python.definitions_['import_me_go_hall_' + dropdown_mode] = 'from me_go import hall_' + dropdown_mode;
...
export const me_go_pin_near_line = function () {
    var key = this.getFieldValue('key');
    Python.definitions_['import_me_go_hall'] = 'from me_go import car';
    var code = 'car.patrol()' + key + '';
    return [code, Python.ORDER_ATOMIC];
};

export const me_go_pin_near = function () {
    var key = this.getFieldValue('key');
    Python.definitions_['import_me_go_hall'] = 'from me_go import car';
...
export const me_go_pin_near_state_change = function () {
    var key = this.getFieldValue('key');
    Python.definitions_['import_me_go_hall'] = 'from me_go import car';
...
export const me_go_pin_light = function () {
    var key = this.getFieldValue('key');
    Python.definitions_['import_me_go_hall'] = 'from me_go import car';
