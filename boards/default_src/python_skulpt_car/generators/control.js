...
//ok
export const controls_flow_statements = function (block) {
...
export const time_sleep = function () {
    Python.definitions_['import_time'] = 'import time';
    var delay_time = Python.valueToCode(this, 'DELAY_TIME', Python.ORDER_ATOMIC) || '1'
    var code = 'time.sleep(' + delay_time + ')\n';
    return code;
};

export const controls_pass = function (block) {
    Python.definitions_.import_blocktool = "import blocktool";
    return "blocktool.highlight('" + block.id + "')\n" + 'pass\n';
};
