...
class Nav extends Component {
    static {
        ...
        HTMLTemplate.add(
            'nav/nav.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/nav.html')))
        );
        ...
        HTMLTemplate.add(
            'nav/nav-btn.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/nav-btn.html')))
        );
        ...
        /**
          ...
          */
        HTMLTemplate.add(
            'nav/nav-item-container.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/nav-item-container.html')))
        );
        ...
        HTMLTemplate.add(
            'nav/nav-item.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/nav-item.html')))
        );
        ...
        /**
          ...
          */
        HTMLTemplate.add(
            'nav/board-selector-div.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/board-selector-div.html')))
        );
        ...
        /**
          ...
          */
        HTMLTemplate.add(
            'nav/port-selector-div.html',
            new HTMLTemplate(goog.get(path.join(Env.templatePath, 'nav/port-selector-div.html')))
        );
    ...
    constructor() {
        super();
        const navTemplate = HTMLTemplate.get('nav/nav.html');
        ...
        const boardSelectTemplate = HTMLTemplate.get('nav/board-selector-div.html');
        ...
        const portSelectTemplate = HTMLTemplate.get('nav/port-selector-div.html');
    ...
    register(config) {
        ...
        switch (scopeType) {
        case Nav.Scope.LEFT:
            config.$moreBtn = $(HTMLTemplate.get('nav/nav-item.html').render({
                mId: id,
                icon,
                text: displayText
            }));
        case Nav.Scope.CENTER:
            config.$btn = $(HTMLTemplate.get('nav/nav-btn.html').render({
                title,
                mId: id,
                icon,
                text: displayText
        ...
        case Nav.Scope.RIGHT:
            if (typeof id === 'string') {
                config.$btn = $(HTMLTemplate.get('nav/nav-item-container.html').render({
                    mId: id,
                    text: displayText
                }));
            } else {
                if (displayText) {
                    config.$btn = $(HTMLTemplate.get('nav/nav-item.html').render({
                        mId: id[1],
                        icon,
                        text: displayText
                    }));
